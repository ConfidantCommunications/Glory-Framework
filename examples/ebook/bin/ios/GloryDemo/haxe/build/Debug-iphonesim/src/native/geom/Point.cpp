...
{
HX_STACK_PUSH("Point::new","native/geom/Point.hx",12);
...
Float Point_obj::get_length( ){
	HX_STACK_PUSH("Point::get_length","native/geom/Point.hx",110);
	HX_STACK_THIS(this);
	HX_STACK_LINE(110)
...
::String Point_obj::toString( ){
	HX_STACK_PUSH("Point::toString","native/geom/Point.hx",96);
	HX_STACK_THIS(this);
	HX_STACK_LINE(96)
...
::native::geom::Point Point_obj::subtract( ::native::geom::Point v){
	HX_STACK_PUSH("Point::subtract","native/geom/Point.hx",89);
	HX_STACK_THIS(this);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(89)
...
{
		HX_STACK_PUSH("Point::offset","native/geom/Point.hx",74);
		HX_STACK_THIS(this);
		HX_STACK_ARG(dx,"dx");
		HX_STACK_ARG(dy,"dy");
		HX_STACK_LINE(76)
...
{
		HX_STACK_PUSH("Point::normalize","native/geom/Point.hx",57);
		HX_STACK_THIS(this);
...
bool Point_obj::equals( ::native::geom::Point toCompare){
	HX_STACK_PUSH("Point::equals","native/geom/Point.hx",43);
	HX_STACK_THIS(this);
...
::native::geom::Point Point_obj::clone( ){
	HX_STACK_PUSH("Point::clone","native/geom/Point.hx",27);
	HX_STACK_THIS(this);
	HX_STACK_LINE(27)
...
::native::geom::Point Point_obj::add( ::native::geom::Point v){
	HX_STACK_PUSH("Point::add","native/geom/Point.hx",20);
	HX_STACK_THIS(this);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(20)
...
Float Point_obj::distance( ::native::geom::Point pt1,::native::geom::Point pt2){
	HX_STACK_PUSH("Point::distance","native/geom/Point.hx",34);
...
::native::geom::Point Point_obj::interpolate( ::native::geom::Point pt1,::native::geom::Point pt2,Float f){
	HX_STACK_PUSH("Point::interpolate","native/geom/Point.hx",50);
	HX_STACK_ARG(pt1,"pt1");
	HX_STACK_ARG(pt2,"pt2");
	HX_STACK_ARG(f,"f");
	HX_STACK_LINE(50)
...
::native::geom::Point Point_obj::polar( Float len,Float angle){
	HX_STACK_PUSH("Point::polar","native/geom/Point.hx",82);
