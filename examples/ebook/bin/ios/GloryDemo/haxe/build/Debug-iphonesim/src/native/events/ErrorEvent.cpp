...
{
HX_STACK_PUSH("ErrorEvent::new","native/events/ErrorEvent.hx",12);
...
::String ErrorEvent_obj::toString( ){
	HX_STACK_PUSH("ErrorEvent::toString","native/events/ErrorEvent.hx",27);
	HX_STACK_THIS(this);
	HX_STACK_LINE(27)
...
::native::events::Event ErrorEvent_obj::clone( ){
	HX_STACK_PUSH("ErrorEvent::clone","native/events/ErrorEvent.hx",20);
	HX_STACK_THIS(this);
	HX_STACK_LINE(20)
