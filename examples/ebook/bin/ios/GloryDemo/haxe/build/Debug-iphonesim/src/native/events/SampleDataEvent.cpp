...
{
HX_STACK_PUSH("SampleDataEvent::new","native/events/SampleDataEvent.hx",15);
...
::String SampleDataEvent_obj::toString( ){
	HX_STACK_PUSH("SampleDataEvent::toString","native/events/SampleDataEvent.hx",33);
	HX_STACK_THIS(this);
	HX_STACK_LINE(33)
...
::native::events::Event SampleDataEvent_obj::clone( ){
	HX_STACK_PUSH("SampleDataEvent::clone","native/events/SampleDataEvent.hx",26);
	HX_STACK_THIS(this);
	HX_STACK_LINE(26)
