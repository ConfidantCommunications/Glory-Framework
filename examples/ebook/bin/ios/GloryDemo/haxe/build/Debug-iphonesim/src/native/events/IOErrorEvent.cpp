...
{
HX_STACK_PUSH("IOErrorEvent::new","native/events/IOErrorEvent.hx",10);
...
::String IOErrorEvent_obj::toString( ){
	HX_STACK_PUSH("IOErrorEvent::toString","native/events/IOErrorEvent.hx",24);
	HX_STACK_THIS(this);
	HX_STACK_LINE(24)
...
::native::events::Event IOErrorEvent_obj::clone( ){
	HX_STACK_PUSH("IOErrorEvent::clone","native/events/IOErrorEvent.hx",17);
	HX_STACK_THIS(this);
	HX_STACK_LINE(17)
