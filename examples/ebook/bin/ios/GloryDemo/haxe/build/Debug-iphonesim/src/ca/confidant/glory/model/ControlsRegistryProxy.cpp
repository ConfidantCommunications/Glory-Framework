...
HX_STACK_PUSH("ControlsRegistryProxy::new","ca/confidant/glory/model/ControlsRegistryProxy.hx",22);
{
	...
	HX_STACK_LINE(25)
	this->controls = Array_obj< ::native::display::DisplayObject >::__new();
	HX_STACK_LINE(26)
...
Void ControlsRegistryProxy_obj::registerControl( ::native::display::DisplayObject d){
{
...
Array< ::native::display::DisplayObject > ControlsRegistryProxy_obj::getControls( ){
...
Dynamic ControlsRegistryProxy_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 4:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"controls") ) { controls=inValue.Cast< Array< ::native::display::DisplayObject > >(); return inValue; }
		break;
	case 11:
