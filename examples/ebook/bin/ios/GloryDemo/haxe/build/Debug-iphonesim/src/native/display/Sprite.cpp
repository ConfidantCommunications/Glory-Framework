...
{
HX_STACK_PUSH("Sprite::new","native/display/Sprite.hx",14);
{
	HX_STACK_LINE(14)
...
{
		HX_STACK_PUSH("Sprite::stopDrag","native/display/Sprite.hx",38);
		HX_STACK_THIS(this);
		HX_STACK_LINE(38)
...
bool lockCenter = __o_lockCenter.Default(false);
	HX_STACK_PUSH("Sprite::startDrag","native/display/Sprite.hx",30);
	HX_STACK_THIS(this);
...
::String Sprite_obj::nmeGetType( ){
	HX_STACK_PUSH("Sprite::nmeGetType","native/display/Sprite.hx",21);
	HX_STACK_THIS(this);
	HX_STACK_LINE(23)
