...
{
HX_STACK_PUSH("JoystickEvent::new","native/events/JoystickEvent.hx",21);
...
::String JoystickEvent_obj::toString( ){
	HX_STACK_PUSH("JoystickEvent::toString","native/events/JoystickEvent.hx",43);
	HX_STACK_THIS(this);
	HX_STACK_LINE(43)
...
::native::events::Event JoystickEvent_obj::clone( ){
	HX_STACK_PUSH("JoystickEvent::clone","native/events/JoystickEvent.hx",36);
	HX_STACK_THIS(this);
	HX_STACK_LINE(36)
