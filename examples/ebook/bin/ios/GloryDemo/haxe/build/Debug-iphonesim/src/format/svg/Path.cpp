...
Dynamic Path_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"joint_style") ) { joint_style=inValue.Cast< ::native::display::JointStyle >(); return inValue; }
		if (HX_FIELD_EQ(inName,"stroke_caps") ) { stroke_caps=inValue.Cast< ::native::display::CapsStyle >(); return inValue; }
		break;
	case 12:
