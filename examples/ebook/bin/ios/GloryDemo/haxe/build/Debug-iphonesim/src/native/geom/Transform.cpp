...
{
HX_STACK_PUSH("Transform::new","native/geom/Transform.hx",19);
{
	HX_STACK_LINE(19)
...
::native::geom::Rectangle Transform_obj::get_pixelBounds( ){
	HX_STACK_PUSH("Transform::get_pixelBounds","native/geom/Transform.hx",39);
	HX_STACK_THIS(this);
	HX_STACK_LINE(39)
...
::native::geom::Matrix Transform_obj::set_matrix( ::native::geom::Matrix inMatrix){
	HX_STACK_PUSH("Transform::set_matrix","native/geom/Transform.hx",38);
	HX_STACK_THIS(this);
...
::native::geom::Matrix Transform_obj::get_matrix( ){
	HX_STACK_PUSH("Transform::get_matrix","native/geom/Transform.hx",37);
	HX_STACK_THIS(this);
	HX_STACK_LINE(37)
...
::native::geom::Matrix Transform_obj::get_concatenatedMatrix( ){
	HX_STACK_PUSH("Transform::get_concatenatedMatrix","native/geom/Transform.hx",36);
	HX_STACK_THIS(this);
	HX_STACK_LINE(36)
...
::native::geom::ColorTransform Transform_obj::get_concatenatedColorTransform( ){
	HX_STACK_PUSH("Transform::get_concatenatedColorTransform","native/geom/Transform.hx",35);
	HX_STACK_THIS(this);
	HX_STACK_LINE(35)
...
::native::geom::ColorTransform Transform_obj::set_colorTransform( ::native::geom::ColorTransform inTrans){
	HX_STACK_PUSH("Transform::set_colorTransform","native/geom/Transform.hx",34);
	HX_STACK_THIS(this);
...
::native::geom::ColorTransform Transform_obj::get_colorTransform( ){
	HX_STACK_PUSH("Transform::get_colorTransform","native/geom/Transform.hx",33);
	HX_STACK_THIS(this);
	HX_STACK_LINE(33)
