...
{
HX_STACK_PUSH("Sound::new","native/media/Sound.hx",30);
...
Float Sound_obj::get_length( ){
	HX_STACK_PUSH("Sound::get_length","native/media/Sound.hx",249);
	HX_STACK_THIS(this);
	HX_STACK_LINE(251)
...
bool Sound_obj::get_isBuffering( ){
	HX_STACK_PUSH("Sound::get_isBuffering","native/media/Sound.hx",241);
	HX_STACK_THIS(this);
	HX_STACK_LINE(243)
...
::native::media::ID3Info Sound_obj::get_id3( ){
	HX_STACK_PUSH("Sound::get_id3","native/media/Sound.hx",227);
	HX_STACK_THIS(this);
	HX_STACK_LINE(229)
	this->nmeCheckLoading();
	HX_STACK_LINE(231)
...
int loops = __o_loops.Default(0);
	HX_STACK_PUSH("Sound::play","native/media/Sound.hx",186);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Sound::nmeOnError","native/media/Sound.hx",177);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Sound::nmeCheckLoading","native/media/Sound.hx",152);
		HX_STACK_THIS(this);
		HX_STACK_LINE(152)
...
Float sampleRate = __o_sampleRate.Default(44100.0);
	HX_STACK_PUSH("Sound::loadPCMFromByteArray","native/media/Sound.hx",107);
	HX_STACK_THIS(this);
	...
	HX_STACK_ARG(sampleRate,"sampleRate");
{
		...
		struct _Function_1_1{
			inline static int Block( ::String &format){
				HX_STACK_PUSH("*::closure","native/media/Sound.hx",113);
				{
					HX_STACK_LINE(113)
...
;
		...
		struct _Function_1_2{
			inline static int Block( ::String &format){
				HX_STACK_PUSH("*::closure","native/media/Sound.hx",121);
				{
					HX_STACK_LINE(121)
...
bool forcePlayAsMusic = __o_forcePlayAsMusic.Default(false);
	HX_STACK_PUSH("Sound::loadCompressedDataFromByteArray","native/media/Sound.hx",93);
	HX_STACK_THIS(this);
	HX_STACK_ARG(bytes,"bytes");
...
bool forcePlayAsMusic = __o_forcePlayAsMusic.Default(false);
	HX_STACK_PUSH("Sound::load","native/media/Sound.hx",72);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Sound::close","native/media/Sound.hx",61);
		HX_STACK_THIS(this);
		HX_STACK_LINE(63)
		if (((this->nmeHandle != null()))){
			HX_STACK_LINE(64)
...
bool useWeakReference = __o_useWeakReference.Default(false);
	HX_STACK_PUSH("Sound::addEventListener","native/media/Sound.hx",44);
	HX_STACK_THIS(this);
