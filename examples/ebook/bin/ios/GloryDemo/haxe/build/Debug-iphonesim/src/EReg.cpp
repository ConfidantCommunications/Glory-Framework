...
{
HX_STACK_PUSH("EReg::new","/usr/lib/haxe/std/cpp/_std/EReg.hx",32);
{
	HX_STACK_LINE(33)
...
::String EReg_obj::customReplace( ::String s,Dynamic f){
	HX_STACK_PUSH("EReg::customReplace","/usr/lib/haxe/std/cpp/_std/EReg.hx",144);
	HX_STACK_THIS(this);
	HX_STACK_ARG(s,"s");
	HX_STACK_ARG(f,"f");
	HX_STACK_LINE(145)
...
::String EReg_obj::replace( ::String s,::String by){
	HX_STACK_PUSH("EReg::replace","/usr/lib/haxe/std/cpp/_std/EReg.hx",93);
	HX_STACK_THIS(this);
	HX_STACK_ARG(s,"s");
	HX_STACK_ARG(by,"by");
	HX_STACK_LINE(94)
			...
			if (((bool((c >= (int)49)) && bool((c <= (int)57))))){
				struct _Function_4_1{
					inline static Dynamic Block( ::EReg_obj *__this,Dynamic &c){
						HX_STACK_PUSH("*::closure","/usr/lib/haxe/std/cpp/_std/EReg.hx",117);
						{
							HX_STACK_LINE(117)
							try{
								HX_STACK_LINE(117)
...
Array< ::String > EReg_obj::split( ::String s){
	HX_STACK_PUSH("EReg::split","/usr/lib/haxe/std/cpp/_std/EReg.hx",69);
	HX_STACK_THIS(this);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(70)
	int pos = (int)0;		HX_STACK_VAR(pos,"pos");
...
Dynamic EReg_obj::matchedPos( ){
	HX_STACK_PUSH("EReg::matchedPos","/usr/lib/haxe/std/cpp/_std/EReg.hx",65);
	HX_STACK_THIS(this);
	HX_STACK_LINE(65)
...
::String EReg_obj::matchedRight( ){
	HX_STACK_PUSH("EReg::matchedRight","/usr/lib/haxe/std/cpp/_std/EReg.hx",59);
	HX_STACK_THIS(this);
	HX_STACK_LINE(60)
	Dynamic p = ::EReg_obj::regexp_matched_pos(this->r,(int)0);		HX_STACK_VAR(p,"p");
	HX_STACK_LINE(61)
...
::String EReg_obj::matchedLeft( ){
	HX_STACK_PUSH("EReg::matchedLeft","/usr/lib/haxe/std/cpp/_std/EReg.hx",54);
	HX_STACK_THIS(this);
	HX_STACK_LINE(55)
	Dynamic p = ::EReg_obj::regexp_matched_pos(this->r,(int)0);		HX_STACK_VAR(p,"p");
	HX_STACK_LINE(56)
...
::String EReg_obj::matched( int n){
	HX_STACK_PUSH("EReg::matched","/usr/lib/haxe/std/cpp/_std/EReg.hx",49);
	HX_STACK_THIS(this);
	HX_STACK_ARG(n,"n");
	HX_STACK_LINE(50)
...
bool EReg_obj::match( ::String s){
	HX_STACK_PUSH("EReg::match","/usr/lib/haxe/std/cpp/_std/EReg.hx",40);
	HX_STACK_THIS(this);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(41)
