...
{
HX_STACK_PUSH("TickerProxy::new","ca/confidant/glory/model/TickerProxy.hx",24);
{
	HX_STACK_LINE(24)
...
{
		HX_STACK_PUSH("TickerProxy::setInterval","ca/confidant/glory/model/TickerProxy.hx",40);
		HX_STACK_THIS(this);
		HX_STACK_ARG(i,"i");
		HX_STACK_LINE(40)
		this->interval = i;
...
{
		HX_STACK_PUSH("TickerProxy::onTimerTick","ca/confidant/glory/model/TickerProxy.hx",36);
		HX_STACK_THIS(this);
		HX_STACK_LINE(36)
...
{
		HX_STACK_PUSH("TickerProxy::stopTimer","ca/confidant/glory/model/TickerProxy.hx",33);
		HX_STACK_THIS(this);
		HX_STACK_LINE(33)
		this->myTimer->stop();
	}
...
int i = __o_i.Default(0);
	HX_STACK_PUSH("TickerProxy::startTimer","ca/confidant/glory/model/TickerProxy.hx",28);
	HX_STACK_THIS(this);
	HX_STACK_ARG(i,"i");
{
		HX_STACK_LINE(30)
