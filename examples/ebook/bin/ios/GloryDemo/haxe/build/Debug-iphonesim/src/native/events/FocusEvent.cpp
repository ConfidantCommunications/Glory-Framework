...
{
HX_STACK_PUSH("FocusEvent::new","native/events/FocusEvent.hx",20);
...
::String FocusEvent_obj::toString( ){
	HX_STACK_PUSH("FocusEvent::toString","native/events/FocusEvent.hx",38);
	HX_STACK_THIS(this);
	HX_STACK_LINE(38)
...
::native::events::Event FocusEvent_obj::clone( ){
	HX_STACK_PUSH("FocusEvent::clone","native/events/FocusEvent.hx",31);
	HX_STACK_THIS(this);
	HX_STACK_LINE(31)
