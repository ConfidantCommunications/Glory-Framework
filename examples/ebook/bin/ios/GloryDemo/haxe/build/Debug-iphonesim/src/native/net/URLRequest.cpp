...
{
HX_STACK_PUSH("URLRequest::new","native/net/URLRequest.hx",30);
{
	HX_STACK_LINE(32)
	if (((inURL != null()))){
		HX_STACK_LINE(33)
...
{
		HX_STACK_PUSH("URLRequest::nmePrepare","native/net/URLRequest.hx",63);
		HX_STACK_THIS(this);
		HX_STACK_LINE(63)
		if (((this->data == null()))){
			HX_STACK_LINE(65)
...
{
		HX_STACK_PUSH("URLRequest::digestAuth","native/net/URLRequest.hx",55);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("URLRequest::basicAuth","native/net/URLRequest.hx",47);
		HX_STACK_THIS(this);
		HX_STACK_ARG(inUser,"inUser");
		HX_STACK_ARG(inPasswd,"inPasswd");
		HX_STACK_LINE(49)
