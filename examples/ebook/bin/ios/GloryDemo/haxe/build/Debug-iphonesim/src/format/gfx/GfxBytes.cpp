...
Void GfxBytes_obj::__construct(::native::utils::ByteArray inBuffer,hx::Null< int >  __o_inFlags)
{
...
int inFlags = __o_inFlags.Default(0);
{
	...
	super::__construct();
	HX_STACK_LINE(42)
	this->buffer = (  (((inBuffer == null()))) ? ::native::utils::ByteArray(::native::utils::ByteArray_obj::__new(null())) : ::native::utils::ByteArray(inBuffer) );
}
;
	return null();
}
...
hx::ObjectPtr< GfxBytes_obj > GfxBytes_obj::__new(::native::utils::ByteArray inBuffer,hx::Null< int >  __o_inFlags)
...
Void GfxBytes_obj::curveTo( Float inCX,Float inCY,Float inX,Float inY){
{
		...
		{
			HX_STACK_LINE(270)
			::native::utils::ByteArray _this = this->buffer;		HX_STACK_VAR(_this,"_this");
			HX_STACK_LINE(270)
...
int GfxBytes_obj::readRGB( ){
	...
	struct _Function_1_1{
		inline static int Block( ::format::gfx::GfxBytes_obj *__this){
			...
			{
				HX_STACK_LINE(195)
				::native::utils::ByteArray _this = __this->buffer;		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(195)
				int val = (  (((_this->position < _this->length))) ? int(_this->b->__get((_this->position)++)) : int(_this->ThrowEOFi()) );		HX_STACK_VAR(val,"val");
				HX_STACK_LINE(195)
		...
		while((true)){
			...
			switch( (int)(_Function_2_1::Block(this))){
				...
				case (int)11: {
					...
					HX_STACK_LINE(116)
					grad->type = ::Type_obj::createEnumIndex(hx::ClassOf< ::native::display::GradientType >(),_Function_3_1::Block(this),null());
...
::String GfxBytes_obj::toString( ){
	...
	HX_STACK_THIS(this);
	HX_STACK_LINE(54)
	::native::utils::ByteArray buf = ::native::utils::ByteArray_obj::__new(this->buffer->length);		HX_STACK_VAR(buf,"buf");
	HX_STACK_LINE(56)
	this->buffer->position = (int)0;
	HX_STACK_LINE(57)
...
::format::gfx::GfxBytes GfxBytes_obj::fromString( ::String inString){
	...
	HX_STACK_LINE(78)
	::native::utils::ByteArray bytes = ::native::utils::ByteArray_obj::fromBytes(::format::gfx::GfxBytes_obj::baseCoder->decodeBytes(::haxe::io::Bytes_obj::ofString(inString)));		HX_STACK_VAR(bytes,"bytes");
	HX_STACK_LINE(81)
...
Array< ::native::display::LineScaleMode > GfxBytes_obj::scaleModes;

Array< ::native::display::CapsStyle > GfxBytes_obj::capsStyles;

Array< ::native::display::JointStyle > GfxBytes_obj::jointStyles;

Array< ::native::display::SpreadMethod > GfxBytes_obj::spreadMethods;

Array< ::native::display::InterpolationMethod > GfxBytes_obj::interpolationMethods;
...
Dynamic GfxBytes_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 10:
		...
		if (HX_FIELD_EQ(inName,"scaleModes") ) { scaleModes=inValue.Cast< Array< ::native::display::LineScaleMode > >(); return inValue; }
		if (HX_FIELD_EQ(inName,"capsStyles") ) { capsStyles=inValue.Cast< Array< ::native::display::CapsStyle > >(); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"jointStyles") ) { jointStyles=inValue.Cast< Array< ::native::display::JointStyle > >(); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"GRADIENT_FILL") ) { GRADIENT_FILL=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"spreadMethods") ) { spreadMethods=inValue.Cast< Array< ::native::display::SpreadMethod > >(); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"END_LINE_STYLE") ) { END_LINE_STYLE=inValue.Cast< int >(); return inValue; }
		break;
	case 20:
		if (HX_FIELD_EQ(inName,"interpolationMethods") ) { interpolationMethods=inValue.Cast< Array< ::native::display::InterpolationMethod > >(); return inValue; }
	}
...
void GfxBytes_obj::__boot()
{
	...
	scaleModes= Array_obj< ::native::display::LineScaleMode >::__new().Add(::native::display::LineScaleMode_obj::NORMAL_dyn()).Add(::native::display::LineScaleMode_obj::NONE_dyn()).Add(::native::display::LineScaleMode_obj::VERTICAL_dyn()).Add(::native::display::LineScaleMode_obj::HORIZONTAL_dyn());
	capsStyles= Array_obj< ::native::display::CapsStyle >::__new().Add(::native::display::CapsStyle_obj::ROUND_dyn()).Add(::native::display::CapsStyle_obj::NONE_dyn()).Add(::native::display::CapsStyle_obj::SQUARE_dyn());
	jointStyles= Array_obj< ::native::display::JointStyle >::__new().Add(::native::display::JointStyle_obj::ROUND_dyn()).Add(::native::display::JointStyle_obj::MITER_dyn()).Add(::native::display::JointStyle_obj::BEVEL_dyn());
	spreadMethods= Array_obj< ::native::display::SpreadMethod >::__new().Add(::native::display::SpreadMethod_obj::PAD_dyn()).Add(::native::display::SpreadMethod_obj::REPEAT_dyn()).Add(::native::display::SpreadMethod_obj::REFLECT_dyn());
	interpolationMethods= Array_obj< ::native::display::InterpolationMethod >::__new().Add(::native::display::InterpolationMethod_obj::RGB_dyn()).Add(::native::display::InterpolationMethod_obj::LINEAR_RGB_dyn());
}
