...
{
HX_STACK_PUSH("Listener::new","native/events/EventDispatcher.hx",189);
{
	HX_STACK_LINE(191)
...
bool Listener_obj::Is( Dynamic inListener,bool inCapture){
	HX_STACK_PUSH("Listener::Is","native/events/EventDispatcher.hx",206);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Listener::dispatchEvent","native/events/EventDispatcher.hx",199);
		HX_STACK_THIS(this);
