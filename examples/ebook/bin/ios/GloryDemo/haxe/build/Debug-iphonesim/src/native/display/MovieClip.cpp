...
{
HX_STACK_PUSH("MovieClip::new","native/display/MovieClip.hx",16);
{
	HX_STACK_LINE(18)
	super::__construct();
	HX_STACK_LINE(20)
...
int MovieClip_obj::get_totalFrames( ){
	HX_STACK_PUSH("MovieClip::get_totalFrames","native/display/MovieClip.hx",70);
	HX_STACK_THIS(this);
	HX_STACK_LINE(70)
...
int MovieClip_obj::get_framesLoaded( ){
	HX_STACK_PUSH("MovieClip::get_framesLoaded","native/display/MovieClip.hx",69);
	HX_STACK_THIS(this);
	HX_STACK_LINE(69)
	return this->mTotalFrames;
}
...
int MovieClip_obj::get_currentFrame( ){
	HX_STACK_PUSH("MovieClip::get_currentFrame","native/display/MovieClip.hx",68);
	HX_STACK_THIS(this);
	HX_STACK_LINE(68)
...
{
		HX_STACK_PUSH("MovieClip::stop","native/display/MovieClip.hx",54);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
		HX_STACK_PUSH("MovieClip::play","native/display/MovieClip.hx",47);
		HX_STACK_THIS(this);
	}
return null();
}
...
::String MovieClip_obj::nmeGetType( ){
	HX_STACK_PUSH("MovieClip::nmeGetType","native/display/MovieClip.hx",40);
	HX_STACK_THIS(this);
	HX_STACK_LINE(40)
...
{
		HX_STACK_PUSH("MovieClip::gotoAndStop","native/display/MovieClip.hx",33);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("MovieClip::gotoAndPlay","native/display/MovieClip.hx",26);
		HX_STACK_THIS(this);
		HX_STACK_ARG(frame,"frame");
		HX_STACK_ARG(scene,"scene");
	}
