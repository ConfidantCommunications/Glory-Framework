...
{
HX_STACK_PUSH("Startup0_RegCommands_Command::new","ca/confidant/glory/controller/Startup0_RegCommands_Command.hx",24);
{
	HX_STACK_LINE(24)
	super::__construct();
}
...
{
		HX_STACK_PUSH("Startup0_RegCommands_Command::execute","ca/confidant/glory/controller/Startup0_RegCommands_Command.hx",28);
		HX_STACK_THIS(this);
		HX_STACK_ARG(note,"note");
		HX_STACK_LINE(29)
		::haxe::Log_obj::trace(HX_CSTRING("startup0"),hx::SourceInfo(HX_CSTRING("Startup0_RegCommands_Command.hx"),29,HX_CSTRING("ca.confidant.glory.controller.Startup0_RegCommands_Command"),HX_CSTRING("execute")));
		HX_STACK_LINE(30)
		...
		HX_STACK_LINE(40)
		this->facade->registerCommand(HX_CSTRING("initPageSounds"),hx::ClassOf< ::ca::confidant::glory::controller::InitPageSoundsCommand >());
		HX_STACK_LINE(41)
		this->facade->registerCommand(HX_CSTRING("destroyPageSounds"),hx::ClassOf< ::ca::confidant::glory::controller::DestroyPageSoundsCommand >());
	}
return null();
}
