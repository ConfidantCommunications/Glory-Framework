...
{
HX_STACK_PUSH("Startup2_Proxies_Command::new","ca/confidant/glory/controller/Startup2_Proxies_Command.hx",18);
{
	HX_STACK_LINE(18)
	super::__construct();
}
...
{
		HX_STACK_PUSH("Startup2_Proxies_Command::execute","ca/confidant/glory/controller/Startup2_Proxies_Command.hx",23);
		HX_STACK_THIS(this);
		HX_STACK_ARG(note,"note");
		HX_STACK_LINE(24)
		::haxe::Log_obj::trace(HX_CSTRING("startup2"),hx::SourceInfo(HX_CSTRING("Startup2_Proxies_Command.hx"),24,HX_CSTRING("ca.confidant.glory.controller.Startup2_Proxies_Command"),HX_CSTRING("execute")));
		HX_STACK_LINE(25)
