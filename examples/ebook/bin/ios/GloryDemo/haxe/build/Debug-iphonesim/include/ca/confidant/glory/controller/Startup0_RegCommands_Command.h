...
#define INCLUDED_ca_confidant_glory_controller_Startup0_RegCommands_Command
...
HX_DECLARE_CLASS4(ca,confidant,glory,controller,Startup0_RegCommands_Command)
...
class Startup0_RegCommands_Command_obj : public ::org::puremvc::haxe::patterns::command::SimpleCommand_obj{
	public:
		typedef ::org::puremvc::haxe::patterns::command::SimpleCommand_obj super;
		typedef Startup0_RegCommands_Command_obj OBJ_;
		Startup0_RegCommands_Command_obj();
		Void __construct();

	public:
		static hx::ObjectPtr< Startup0_RegCommands_Command_obj > __new();
		...
		::String __ToString() const { return HX_CSTRING("Startup0_RegCommands_Command"); }
...
#endif /* INCLUDED_ca_confidant_glory_controller_Startup0_RegCommands_Command */ 
