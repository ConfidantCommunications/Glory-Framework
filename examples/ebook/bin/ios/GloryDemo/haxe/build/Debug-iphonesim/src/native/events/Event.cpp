...
{
HX_STACK_PUSH("Event::new","native/events/Event.hx",51);
...
::String Event_obj::get_type( ){
	HX_STACK_PUSH("Event::get_type","native/events/Event.hx",131);
	HX_STACK_THIS(this);
	HX_STACK_LINE(131)
	return this->_type;
}
...
Dynamic Event_obj::set_target( Dynamic v){
	HX_STACK_PUSH("Event::set_target","native/events/Event.hx",130);
	HX_STACK_THIS(this);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(130)
	this->_target = v;
...
Dynamic Event_obj::get_target( ){
	HX_STACK_PUSH("Event::get_target","native/events/Event.hx",129);
	HX_STACK_THIS(this);
	HX_STACK_LINE(129)
	return this->_target;
}
...
int Event_obj::get_eventPhase( ){
	HX_STACK_PUSH("Event::get_eventPhase","native/events/Event.hx",128);
	HX_STACK_THIS(this);
	HX_STACK_LINE(128)
...
Dynamic Event_obj::set_currentTarget( Dynamic v){
	HX_STACK_PUSH("Event::set_currentTarget","native/events/Event.hx",127);
	HX_STACK_THIS(this);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(127)
...
Dynamic Event_obj::get_currentTarget( ){
	HX_STACK_PUSH("Event::get_currentTarget","native/events/Event.hx",126);
	HX_STACK_THIS(this);
	HX_STACK_LINE(126)
...
bool Event_obj::get_bubbles( ){
	HX_STACK_PUSH("Event::get_bubbles","native/events/Event.hx",124);
	HX_STACK_THIS(this);
	HX_STACK_LINE(124)
...
::String Event_obj::toString( ){
	HX_STACK_PUSH("Event::toString","native/events/Event.hx",110);
	HX_STACK_THIS(this);
	HX_STACK_LINE(110)
...
{
		HX_STACK_PUSH("Event::stopPropagation","native/events/Event.hx",102);
		HX_STACK_THIS(this);
		HX_STACK_LINE(102)
...
{
		HX_STACK_PUSH("Event::stopImmediatePropagation","native/events/Event.hx",94);
		HX_STACK_THIS(this);
		HX_STACK_LINE(94)
		if ((this->get_cancelable())){
			HX_STACK_LINE(97)
...
{
		HX_STACK_PUSH("Event::nmeSetPhase","native/events/Event.hx",86);
		HX_STACK_THIS(this);
...
bool Event_obj::nmeGetIsCancelledNow( ){
	HX_STACK_PUSH("Event::nmeGetIsCancelledNow","native/events/Event.hx",79);
	HX_STACK_THIS(this);
	HX_STACK_LINE(79)
...
bool Event_obj::nmeGetIsCancelled( ){
	HX_STACK_PUSH("Event::nmeGetIsCancelled","native/events/Event.hx",72);
	HX_STACK_THIS(this);
	HX_STACK_LINE(72)
...
::native::events::Event Event_obj::clone( ){
	HX_STACK_PUSH("Event::clone","native/events/Event.hx",65);
	HX_STACK_THIS(this);
	HX_STACK_LINE(65)
