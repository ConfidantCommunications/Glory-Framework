...
{
HX_STACK_PUSH("OptimizedPerlin::new","native/display/BitmapData.hx",543);
...
{
		HX_STACK_PUSH("OptimizedPerlin::seedOffset","native/display/BitmapData.hx",692);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("OptimizedPerlin::octFreqPers","native/display/BitmapData.hx",669);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("OptimizedPerlin::fill","native/display/BitmapData.hx",552);
		HX_STACK_THIS(this);
							...
							while(((_g2 < octaves))){
								...
								struct _Function_7_1{
									inline static Float Block( Float &y1,Float &x1,int &hash){
										HX_STACK_PUSH("*::closure","native/display/BitmapData.hx",613);
										{
											HX_STACK_LINE(613)
								...
								struct _Function_7_3{
									inline static Float Block( Float &y1,int &hash,Float &x){
										HX_STACK_PUSH("*::closure","native/display/BitmapData.hx",616);
										{
											HX_STACK_LINE(616)
								...
								struct _Function_7_5{
									inline static Float Block( Float &x1,Float &y,int &hash){
										HX_STACK_PUSH("*::closure","native/display/BitmapData.hx",619);
										{
											HX_STACK_LINE(619)
								...
								struct _Function_7_7{
									inline static Float Block( Float &y,int &hash,Float &x){
										HX_STACK_PUSH("*::closure","native/display/BitmapData.hx",622);
										{
											HX_STACK_LINE(622)
								...
								struct _Function_7_9{
									inline static Float Block( Float &y1,Float &x1,int &hash){
										HX_STACK_PUSH("*::closure","native/display/BitmapData.hx",625);
										{
											HX_STACK_LINE(625)
											return (  (((hash < (int)8))) ? Float(x1) : Float(y1) );
										}
								...
								struct _Function_7_11{
									inline static Float Block( Float &y1,int &hash,Float &x){
										HX_STACK_PUSH("*::closure","native/display/BitmapData.hx",628);
										{
											HX_STACK_LINE(628)
											return (  (((hash < (int)8))) ? Float(x) : Float(y1) );
										}
								...
								struct _Function_7_13{
									inline static Float Block( Float &x1,Float &y,int &hash){
										HX_STACK_PUSH("*::closure","native/display/BitmapData.hx",631);
										{
											HX_STACK_LINE(631)
											return (  (((hash < (int)8))) ? Float(x1) : Float(y) );
										}
								...
								struct _Function_7_15{
									inline static Float Block( Float &y,int &hash,Float &x){
										HX_STACK_PUSH("*::closure","native/display/BitmapData.hx",634);
										{
											HX_STACK_LINE(634)
											return (  (((hash < (int)8))) ? Float(x) : Float(y) );
										}
