...
{
HX_STACK_PUSH("InteractiveObject::new","native/display/InteractiveObject.hx",18);
{
	HX_STACK_LINE(20)
...
bool InteractiveObject_obj::get_needsSoftKeyboard( ){
	HX_STACK_PUSH("InteractiveObject::get_needsSoftKeyboard","native/display/InteractiveObject.hx",82);
	HX_STACK_THIS(this);
	HX_STACK_LINE(82)
...
bool InteractiveObject_obj::set_needsSoftKeyboard( bool inVal){
	HX_STACK_PUSH("InteractiveObject::set_needsSoftKeyboard","native/display/InteractiveObject.hx",74);
	HX_STACK_THIS(this);
...
bool InteractiveObject_obj::get_moveForSoftKeyboard( ){
	HX_STACK_PUSH("InteractiveObject::get_moveForSoftKeyboard","native/display/InteractiveObject.hx",67);
	HX_STACK_THIS(this);
	HX_STACK_LINE(67)
...
bool InteractiveObject_obj::set_moveForSoftKeyboard( bool inVal){
	HX_STACK_PUSH("InteractiveObject::set_moveForSoftKeyboard","native/display/InteractiveObject.hx",59);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inVal,"inVal");
	HX_STACK_LINE(61)
...
bool InteractiveObject_obj::set_mouseEnabled( bool inVal){
	HX_STACK_PUSH("InteractiveObject::set_mouseEnabled","native/display/InteractiveObject.hx",50);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inVal,"inVal");
	HX_STACK_LINE(52)
...
bool InteractiveObject_obj::get_mouseEnabled( ){
	HX_STACK_PUSH("InteractiveObject::get_mouseEnabled","native/display/InteractiveObject.hx",49);
	HX_STACK_THIS(this);
	HX_STACK_LINE(49)
	return this->nmeMouseEnabled;
}
...
bool InteractiveObject_obj::requestSoftKeyboard( ){
	HX_STACK_PUSH("InteractiveObject::requestSoftKeyboard","native/display/InteractiveObject.hx",35);
	HX_STACK_THIS(this);
	HX_STACK_LINE(35)
...
::native::display::InteractiveObject InteractiveObject_obj::nmeAsInteractiveObject( ){
	HX_STACK_PUSH("InteractiveObject::nmeAsInteractiveObject","native/display/InteractiveObject.hx",28);
	HX_STACK_THIS(this);
	HX_STACK_LINE(28)
