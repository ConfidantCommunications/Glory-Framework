...
{
HX_STACK_PUSH("WeakRef::new","native/utils/WeakRef.hx",15);
...
::String WeakRef_obj::toString( ){
	HX_STACK_PUSH("WeakRef::toString","native/utils/WeakRef.hx",49);
	HX_STACK_THIS(this);
	HX_STACK_LINE(51)
...
Dynamic WeakRef_obj::get( ){
	HX_STACK_PUSH("WeakRef::get","native/utils/WeakRef.hx",32);
	HX_STACK_THIS(this);
	HX_STACK_LINE(34)
	if (((this->hardRef != null()))){
		HX_STACK_LINE(35)
