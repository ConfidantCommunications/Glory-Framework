...
{
HX_STACK_PUSH("Bitmap::new","native/display/Bitmap.hx",17);
...
bool Bitmap_obj::set_smoothing( bool inSmooth){
	HX_STACK_PUSH("Bitmap::set_smoothing","native/display/Bitmap.hx",74);
	HX_STACK_THIS(this);
...
::native::display::BitmapData Bitmap_obj::set_bitmapData( ::native::display::BitmapData inBitmapData){
	HX_STACK_PUSH("Bitmap::set_bitmapData","native/display/Bitmap.hx",64);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Bitmap::nmeRebuild","native/display/Bitmap.hx",37);
		HX_STACK_THIS(this);
		HX_STACK_LINE(37)
