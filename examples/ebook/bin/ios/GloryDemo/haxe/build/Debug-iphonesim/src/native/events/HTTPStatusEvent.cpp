...
{
HX_STACK_PUSH("HTTPStatusEvent::new","native/events/HTTPStatusEvent.hx",12);
...
::String HTTPStatusEvent_obj::toString( ){
	HX_STACK_PUSH("HTTPStatusEvent::toString","native/events/HTTPStatusEvent.hx",28);
	HX_STACK_THIS(this);
	HX_STACK_LINE(28)
...
::native::events::Event HTTPStatusEvent_obj::clone( ){
	HX_STACK_PUSH("HTTPStatusEvent::clone","native/events/HTTPStatusEvent.hx",21);
	HX_STACK_THIS(this);
	HX_STACK_LINE(21)
