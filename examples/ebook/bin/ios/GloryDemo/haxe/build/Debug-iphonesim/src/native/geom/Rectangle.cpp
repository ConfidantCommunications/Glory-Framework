...
{
HX_STACK_PUSH("Rectangle::new","native/geom/Rectangle.hx",20);
{
	HX_STACK_LINE(22)
...
::native::geom::Point Rectangle_obj::set_topLeft( ::native::geom::Point p){
	HX_STACK_PUSH("Rectangle::set_topLeft","native/geom/Rectangle.hx",231);
	HX_STACK_THIS(this);
	HX_STACK_ARG(p,"p");
	HX_STACK_LINE(231)
	this->x = p->x;
...
::native::geom::Point Rectangle_obj::get_topLeft( ){
	HX_STACK_PUSH("Rectangle::get_topLeft","native/geom/Rectangle.hx",230);
	HX_STACK_THIS(this);
	HX_STACK_LINE(230)
...
Float Rectangle_obj::set_top( Float t){
	HX_STACK_PUSH("Rectangle::set_top","native/geom/Rectangle.hx",229);
	HX_STACK_THIS(this);
	HX_STACK_ARG(t,"t");
	HX_STACK_LINE(229)
...
Float Rectangle_obj::get_top( ){
	HX_STACK_PUSH("Rectangle::get_top","native/geom/Rectangle.hx",228);
	HX_STACK_THIS(this);
	HX_STACK_LINE(228)
	return this->y;
}
...
::native::geom::Point Rectangle_obj::set_size( ::native::geom::Point p){
	HX_STACK_PUSH("Rectangle::set_size","native/geom/Rectangle.hx",227);
	HX_STACK_THIS(this);
	HX_STACK_ARG(p,"p");
	HX_STACK_LINE(227)
	this->width = p->x;
...
::native::geom::Point Rectangle_obj::get_size( ){
	HX_STACK_PUSH("Rectangle::get_size","native/geom/Rectangle.hx",226);
	HX_STACK_THIS(this);
	HX_STACK_LINE(226)
...
Float Rectangle_obj::set_right( Float r){
	HX_STACK_PUSH("Rectangle::set_right","native/geom/Rectangle.hx",225);
	HX_STACK_THIS(this);
	HX_STACK_ARG(r,"r");
	HX_STACK_LINE(225)
	this->width = (r - this->x);
...
Float Rectangle_obj::get_right( ){
	HX_STACK_PUSH("Rectangle::get_right","native/geom/Rectangle.hx",224);
	HX_STACK_THIS(this);
	HX_STACK_LINE(224)
...
Float Rectangle_obj::set_left( Float l){
	HX_STACK_PUSH("Rectangle::set_left","native/geom/Rectangle.hx",223);
	HX_STACK_THIS(this);
	HX_STACK_ARG(l,"l");
	HX_STACK_LINE(223)
...
Float Rectangle_obj::get_left( ){
	HX_STACK_PUSH("Rectangle::get_left","native/geom/Rectangle.hx",222);
	HX_STACK_THIS(this);
	HX_STACK_LINE(222)
	return this->x;
}
...
::native::geom::Point Rectangle_obj::set_bottomRight( ::native::geom::Point p){
	HX_STACK_PUSH("Rectangle::set_bottomRight","native/geom/Rectangle.hx",221);
	HX_STACK_THIS(this);
	HX_STACK_ARG(p,"p");
	HX_STACK_LINE(221)
...
::native::geom::Point Rectangle_obj::get_bottomRight( ){
	HX_STACK_PUSH("Rectangle::get_bottomRight","native/geom/Rectangle.hx",220);
	HX_STACK_THIS(this);
	HX_STACK_LINE(220)
...
Float Rectangle_obj::set_bottom( Float b){
	HX_STACK_PUSH("Rectangle::set_bottom","native/geom/Rectangle.hx",219);
	HX_STACK_THIS(this);
	HX_STACK_ARG(b,"b");
	HX_STACK_LINE(219)
...
Float Rectangle_obj::get_bottom( ){
	HX_STACK_PUSH("Rectangle::get_bottom","native/geom/Rectangle.hx",218);
	HX_STACK_THIS(this);
	HX_STACK_LINE(218)
...
::native::geom::Rectangle Rectangle_obj::_union( ::native::geom::Rectangle toUnion){
	HX_STACK_PUSH("Rectangle::union","native/geom/Rectangle.hx",200);
	HX_STACK_THIS(this);
...
::native::geom::Rectangle Rectangle_obj::transform( ::native::geom::Matrix m){
	HX_STACK_PUSH("Rectangle::transform","native/geom/Rectangle.hx",167);
	HX_STACK_THIS(this);
	HX_STACK_ARG(m,"m");
	HX_STACK_LINE(169)
...
{
		HX_STACK_PUSH("Rectangle::setEmpty","native/geom/Rectangle.hx",160);
		HX_STACK_THIS(this);
		HX_STACK_LINE(160)
...
{
		HX_STACK_PUSH("Rectangle::offsetPoint","native/geom/Rectangle.hx",152);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Rectangle::offset","native/geom/Rectangle.hx",144);
		HX_STACK_THIS(this);
		HX_STACK_ARG(dx,"dx");
		HX_STACK_ARG(dy,"dy");
		HX_STACK_LINE(146)
...
bool Rectangle_obj::isEmpty( ){
	HX_STACK_PUSH("Rectangle::isEmpty","native/geom/Rectangle.hx",137);
	HX_STACK_THIS(this);
	HX_STACK_LINE(137)
...
bool Rectangle_obj::intersects( ::native::geom::Rectangle toIntersect){
	HX_STACK_PUSH("Rectangle::intersects","native/geom/Rectangle.hx",123);
	HX_STACK_THIS(this);
...
::native::geom::Rectangle Rectangle_obj::intersection( ::native::geom::Rectangle toIntersect){
	HX_STACK_PUSH("Rectangle::intersection","native/geom/Rectangle.hx",107);
	HX_STACK_THIS(this);
	HX_STACK_ARG(toIntersect,"toIntersect");
	HX_STACK_LINE(109)
	Float x0 = (  (((this->x < toIntersect->x))) ? Float(toIntersect->x) : Float(this->x) );		HX_STACK_VAR(x0,"x0");
...
{
		HX_STACK_PUSH("Rectangle::inflatePoint","native/geom/Rectangle.hx",100);
		HX_STACK_THIS(this);
		HX_STACK_ARG(point,"point");
		HX_STACK_LINE(100)
...
{
		HX_STACK_PUSH("Rectangle::inflate","native/geom/Rectangle.hx",92);
		HX_STACK_THIS(this);
		HX_STACK_ARG(dx,"dx");
		HX_STACK_ARG(dy,"dy");
		HX_STACK_LINE(94)
...
{
		HX_STACK_PUSH("Rectangle::extendBounds","native/geom/Rectangle.hx",65);
		HX_STACK_THIS(this);
		HX_STACK_ARG(r,"r");
		HX_STACK_LINE(67)
...
bool Rectangle_obj::equals( ::native::geom::Rectangle toCompare){
	HX_STACK_PUSH("Rectangle::equals","native/geom/Rectangle.hx",58);
	HX_STACK_THIS(this);
...
bool Rectangle_obj::containsRect( ::native::geom::Rectangle rect){
	HX_STACK_PUSH("Rectangle::containsRect","native/geom/Rectangle.hx",51);
	HX_STACK_THIS(this);
...
bool Rectangle_obj::containsPoint( ::native::geom::Point point){
	HX_STACK_PUSH("Rectangle::containsPoint","native/geom/Rectangle.hx",44);
	HX_STACK_THIS(this);
	HX_STACK_ARG(point,"point");
	HX_STACK_LINE(44)
...
bool Rectangle_obj::contains( Float inX,Float inY){
	HX_STACK_PUSH("Rectangle::contains","native/geom/Rectangle.hx",37);
	HX_STACK_THIS(this);
...
::native::geom::Rectangle Rectangle_obj::clone( ){
	HX_STACK_PUSH("Rectangle::clone","native/geom/Rectangle.hx",30);
	HX_STACK_THIS(this);
	HX_STACK_LINE(30)
