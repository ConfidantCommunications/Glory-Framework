...
Void ControlComponent_obj::__construct(::String action)
{
HX_STACK_PUSH("ControlComponent::new","ca/confidant/glory/view/components/ControlComponent.hx",17);
{
	HX_STACK_LINE(18)
	super::__construct();
	HX_STACK_LINE(20)
...
hx::ObjectPtr< ControlComponent_obj > ControlComponent_obj::__new(::String action)
{  hx::ObjectPtr< ControlComponent_obj > result = new ControlComponent_obj();
	result->__construct(action);
	return result;}
...
{
		HX_STACK_PUSH("ControlComponent::addSVG","ca/confidant/glory/view/components/ControlComponent.hx",27);
		HX_STACK_THIS(this);
		HX_STACK_ARG(t,"t");
		HX_STACK_LINE(28)
		::format::SVG svg = ::format::SVG_obj::__new(t);		HX_STACK_VAR(svg,"svg");
		HX_STACK_LINE(29)
		svg->render(this->get_graphics(),null(),null(),null(),null());
	}
return null();
}
...
Void ControlComponent_obj::addBitmap( ::native::display::Bitmap bMap){
{
		HX_STACK_PUSH("ControlComponent::addBitmap","ca/confidant/glory/view/components/ControlComponent.hx",23);
		HX_STACK_THIS(this);
...
Dynamic ControlComponent_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 6:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"defaultBitmap") ) { defaultBitmap=inValue.Cast< ::native::display::Bitmap >(); return inValue; }
	}
