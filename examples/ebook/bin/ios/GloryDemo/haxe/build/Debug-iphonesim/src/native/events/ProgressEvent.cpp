...
{
HX_STACK_PUSH("ProgressEvent::new","native/events/ProgressEvent.hx",14);
...
::String ProgressEvent_obj::toString( ){
	HX_STACK_PUSH("ProgressEvent::toString","native/events/ProgressEvent.hx",31);
	HX_STACK_THIS(this);
	HX_STACK_LINE(31)
...
::native::events::Event ProgressEvent_obj::clone( ){
	HX_STACK_PUSH("ProgressEvent::clone","native/events/ProgressEvent.hx",24);
	HX_STACK_THIS(this);
	HX_STACK_LINE(24)
