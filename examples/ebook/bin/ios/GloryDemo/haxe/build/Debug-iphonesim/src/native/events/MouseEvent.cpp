...
{
HX_STACK_PUSH("MouseEvent::new","native/events/MouseEvent.hx",48);
...
{
		HX_STACK_PUSH("MouseEvent::updateAfterEvent","native/events/MouseEvent.hx",107);
		HX_STACK_THIS(this);
	}
return null();
}
...
::String MouseEvent_obj::toString( ){
	HX_STACK_PUSH("MouseEvent::toString","native/events/MouseEvent.hx",100);
	HX_STACK_THIS(this);
	HX_STACK_LINE(100)
...
::native::events::MouseEvent MouseEvent_obj::nmeCreateSimilar( ::String inType,::native::display::InteractiveObject related,::native::display::InteractiveObject targ){
	HX_STACK_PUSH("MouseEvent::nmeCreateSimilar","native/events/MouseEvent.hx",85);
	HX_STACK_THIS(this);
...
::native::events::Event MouseEvent_obj::clone( ){
	HX_STACK_PUSH("MouseEvent::clone","native/events/MouseEvent.hx",66);
	HX_STACK_THIS(this);
	HX_STACK_LINE(66)
...
::native::events::MouseEvent MouseEvent_obj::nmeCreate( ::String inType,Dynamic inEvent,::native::geom::Point inLocal,::native::display::InteractiveObject inTarget){
	HX_STACK_PUSH("MouseEvent::nmeCreate","native/events/MouseEvent.hx",73);
	HX_STACK_ARG(inType,"inType");
