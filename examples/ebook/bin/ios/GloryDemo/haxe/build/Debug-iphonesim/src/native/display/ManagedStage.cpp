...
{
HX_STACK_PUSH("ManagedStage::new","native/display/ManagedStage.hx",41);
...
{
		HX_STACK_PUSH("ManagedStage::setNextWake","native/display/ManagedStage.hx",104);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("ManagedStage::sendQuit","native/display/ManagedStage.hx",97);
		HX_STACK_THIS(this);
		struct _Function_1_1{
			inline static Dynamic Block( ){
				HX_STACK_PUSH("*::closure","native/display/ManagedStage.hx",99);
				{
...
{
		HX_STACK_PUSH("ManagedStage::resize","native/display/ManagedStage.hx",90);
		HX_STACK_THIS(this);
		HX_STACK_ARG(inWidth,"inWidth");
		HX_STACK_ARG(inHeight,"inHeight");
		struct _Function_1_1{
			inline static Dynamic Block( int &inWidth,int &inHeight){
				HX_STACK_PUSH("*::closure","native/display/ManagedStage.hx",92);
				{
					hx::Anon __result = hx::Anon_obj::Create();
...
{
		HX_STACK_PUSH("ManagedStage::pumpEvent","native/display/ManagedStage.hx",83);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("ManagedStage::nmeRender","native/display/ManagedStage.hx",74);
		HX_STACK_THIS(this);
...
Float ManagedStage_obj::nmeDoProcessStageEvent( Dynamic inEvent){
	HX_STACK_PUSH("ManagedStage::nmeDoProcessStageEvent","native/display/ManagedStage.hx",62);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inEvent,"inEvent");
	HX_STACK_LINE(64)
	this->nmePollTimers();
...
Void run(){
{
		HX_STACK_PUSH("ManagedStage::endRender","native/display/ManagedStage.hx",55);
		HX_STACK_THIS(this);
	}
return null();
}
...
Void run(){
{
		HX_STACK_PUSH("ManagedStage::beginRender","native/display/ManagedStage.hx",48);
		HX_STACK_THIS(this);
	}
return null();
}
