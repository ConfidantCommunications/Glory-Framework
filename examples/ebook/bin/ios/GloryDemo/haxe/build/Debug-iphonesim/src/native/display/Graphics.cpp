...
{
HX_STACK_PUSH("Graphics::new","native/display/Graphics.hx",24);
{
	HX_STACK_LINE(24)
...
{
		HX_STACK_PUSH("Graphics::moveTo","native/display/Graphics.hx",203);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Graphics::lineTo","native/display/Graphics.hx",196);
		HX_STACK_THIS(this);
		HX_STACK_ARG(inX,"inX");
		HX_STACK_ARG(inY,"inY");
		HX_STACK_LINE(196)
...
Float miterLimit = __o_miterLimit.Default(3);
	HX_STACK_PUSH("Graphics::lineStyle","native/display/Graphics.hx",189);
	HX_STACK_THIS(this);
...
Float focalPointRatio = __o_focalPointRatio.Default(0.0);
	HX_STACK_PUSH("Graphics::lineGradientStyle","native/display/Graphics.hx",175);
	HX_STACK_THIS(this);
...
bool smooth = __o_smooth.Default(false);
	HX_STACK_PUSH("Graphics::lineBitmapStyle","native/display/Graphics.hx",168);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Graphics::endFill","native/display/Graphics.hx",161);
		HX_STACK_THIS(this);
		HX_STACK_LINE(161)
...
int blendMode = __o_blendMode.Default(0);
	HX_STACK_PUSH("Graphics::drawTriangles","native/display/Graphics.hx",153);
	HX_STACK_THIS(this);
...
int inFlags = __o_inFlags.Default(0);
	HX_STACK_PUSH("Graphics::drawTiles","native/display/Graphics.hx",141);
	HX_STACK_THIS(this);
...
::String winding = __o_winding.Default(HX_CSTRING("evenOdd"));
	HX_STACK_PUSH("Graphics::drawPath","native/display/Graphics.hx",134);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Graphics::drawRoundRect","native/display/Graphics.hx",127);
		HX_STACK_THIS(this);
		HX_STACK_ARG(inX,"inX");
		HX_STACK_ARG(inY,"inY");
...
{
		HX_STACK_PUSH("Graphics::drawRect","native/display/Graphics.hx",120);
		HX_STACK_THIS(this);
		HX_STACK_ARG(inX,"inX");
		HX_STACK_ARG(inY,"inY");
		HX_STACK_ARG(inWidth,"inWidth");
...
Float inSize = __o_inSize.Default(-1.0);
	HX_STACK_PUSH("Graphics::drawPoints","native/display/Graphics.hx",113);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Graphics::drawGraphicsDatum","native/display/Graphics.hx",106);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Graphics::drawGraphicsData","native/display/Graphics.hx",94);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Graphics::drawEllipse","native/display/Graphics.hx",87);
		HX_STACK_THIS(this);
		HX_STACK_ARG(inX,"inX");
		HX_STACK_ARG(inY,"inY");
		HX_STACK_ARG(inWidth,"inWidth");
...
{
		HX_STACK_PUSH("Graphics::drawCircle","native/display/Graphics.hx",80);
		HX_STACK_THIS(this);
		HX_STACK_ARG(inX,"inX");
		HX_STACK_ARG(inY,"inY");
...
{
		HX_STACK_PUSH("Graphics::curveTo","native/display/Graphics.hx",73);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Graphics::clear","native/display/Graphics.hx",66);
		HX_STACK_THIS(this);
		HX_STACK_LINE(66)
...
Float focalPointRatio = __o_focalPointRatio.Default(0.0);
	HX_STACK_PUSH("Graphics::beginGradientFill","native/display/Graphics.hx",52);
	HX_STACK_THIS(this);
	HX_STACK_ARG(type,"type");
	HX_STACK_ARG(colors,"colors");
	HX_STACK_ARG(alphas,"alphas");
...
Float alpha = __o_alpha.Default(1.0);
	HX_STACK_PUSH("Graphics::beginFill","native/display/Graphics.hx",45);
	HX_STACK_THIS(this);
	HX_STACK_ARG(color,"color");
	HX_STACK_ARG(alpha,"alpha");
{
...
bool repeat = __o_repeat.Default(true);
bool smooth = __o_smooth.Default(false);
	HX_STACK_PUSH("Graphics::beginBitmapFill","native/display/Graphics.hx",38);
	HX_STACK_THIS(this);
	HX_STACK_ARG(bitmap,"bitmap");
	HX_STACK_ARG(matrix,"matrix");
	HX_STACK_ARG(repeat,"repeat");
...
{
		HX_STACK_PUSH("Graphics::arcTo","native/display/Graphics.hx",31);
		HX_STACK_THIS(this);
		HX_STACK_ARG(inCX,"inCX");
		HX_STACK_ARG(inCY,"inCY");
		HX_STACK_ARG(inX,"inX");
...
int inA = __o_inA.Default(255);
	HX_STACK_PUSH("Graphics::RGBA","native/display/Graphics.hx",210);
