...
bool BitmapData_obj::get_transparent( ){
	HX_STACK_PUSH("BitmapData::get_transparent","native/display/BitmapData.hx",418);
	HX_STACK_THIS(this);
	HX_STACK_LINE(418)
...
int BitmapData_obj::get_height( ){
	HX_STACK_PUSH("BitmapData::get_height","native/display/BitmapData.hx",417);
	HX_STACK_THIS(this);
	HX_STACK_LINE(417)
...
int BitmapData_obj::get_width( ){
	HX_STACK_PUSH("BitmapData::get_width","native/display/BitmapData.hx",416);
	HX_STACK_THIS(this);
	HX_STACK_LINE(416)
...
::native::geom::Rectangle BitmapData_obj::get_rect( ){
	HX_STACK_PUSH("BitmapData::get_rect","native/display/BitmapData.hx",415);
	HX_STACK_THIS(this);
	HX_STACK_LINE(415)
...
bool grayScale = __o_grayScale.Default(false);
	HX_STACK_PUSH("BitmapData::noise","native/display/BitmapData.hx",401);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::setFormat","native/display/BitmapData.hx",394);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::unlock","native/display/BitmapData.hx",387);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::setVector","native/display/BitmapData.hx",369);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::setPixels","native/display/BitmapData.hx",359);
		HX_STACK_THIS(this);
		HX_STACK_ARG(rect,"rect");
...
{
		HX_STACK_PUSH("BitmapData::setPixel32","native/display/BitmapData.hx",348);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::setPixel","native/display/BitmapData.hx",341);
		HX_STACK_THIS(this);
		HX_STACK_ARG(inX,"inX");
		HX_STACK_ARG(inY,"inY");
		HX_STACK_ARG(inColour,"inColour");
...
{
		HX_STACK_PUSH("BitmapData::setFlags","native/display/BitmapData.hx",333);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::scroll","native/display/BitmapData.hx",326);
		HX_STACK_THIS(this);
...
int channelOptions = __o_channelOptions.Default(7);
bool grayScale = __o_grayScale.Default(false);
	HX_STACK_PUSH("BitmapData::perlinNoise","native/display/BitmapData.hx",318);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::nmeDrawToSurface","native/display/BitmapData.hx",310);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::lock","native/display/BitmapData.hx",303);
		HX_STACK_THIS(this);
	}
return null();
}
...
Array< int > BitmapData_obj::getVector( ::native::geom::Rectangle rect){
	HX_STACK_PUSH("BitmapData::getVector","native/display/BitmapData.hx",256);
	HX_STACK_THIS(this);
	HX_STACK_ARG(rect,"rect");
	HX_STACK_LINE(258)
...
int format = __o_format.Default(0);
	HX_STACK_PUSH("BitmapData::load","native/display/BitmapData.hx",278);
...
::native::display::BitmapData BitmapData_obj::loadFromBytes( ::native::utils::ByteArray inBytes,::native::utils::ByteArray inRawAlpha){
	HX_STACK_PUSH("BitmapData::loadFromBytes","native/display/BitmapData.hx",287);
...
::native::display::BitmapData BitmapData_obj::loadFromHaxeBytes( ::haxe::io::Bytes inBytes,::haxe::io::Bytes inRawAlpha){
	HX_STACK_PUSH("BitmapData::loadFromHaxeBytes","native/display/BitmapData.hx",296);
	HX_STACK_ARG(inBytes,"inBytes");
	HX_STACK_ARG(inRawAlpha,"inRawAlpha");
	HX_STACK_LINE(296)
