...
{
HX_STACK_PUSH("KeyboardEvent::new","native/events/KeyboardEvent.hx",20);
...
::String KeyboardEvent_obj::toString( ){
	HX_STACK_PUSH("KeyboardEvent::toString","native/events/KeyboardEvent.hx",44);
	HX_STACK_THIS(this);
	HX_STACK_LINE(44)
...
::native::events::Event KeyboardEvent_obj::clone( ){
	HX_STACK_PUSH("KeyboardEvent::clone","native/events/KeyboardEvent.hx",37);
	HX_STACK_THIS(this);
	HX_STACK_LINE(37)
