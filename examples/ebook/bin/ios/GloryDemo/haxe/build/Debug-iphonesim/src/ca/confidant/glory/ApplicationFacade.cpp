...
{
		HX_STACK_PUSH("ApplicationFacade::startup","ca/confidant/glory/ApplicationFacade.hx",64);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("ApplicationFacade::initializeController","ca/confidant/glory/ApplicationFacade.hx",57);
		HX_STACK_THIS(this);
		HX_STACK_LINE(58)
...
::String ApplicationFacade_obj::INIT_PAGE_SOUNDS;

::String ApplicationFacade_obj::DESTROY_PAGE_SOUNDS;
...
::ca::confidant::glory::ApplicationFacade ApplicationFacade_obj::getInstance( ){
	HX_STACK_PUSH("ApplicationFacade::getInstance","ca/confidant/glory/ApplicationFacade.hx",49);
	HX_STACK_LINE(50)
...
Dynamic ApplicationFacade_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 14:
		...
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"INIT_PAGE_SOUNDS") ) { return INIT_PAGE_SOUNDS; }
		break;
	case 17:
	...
	case 18:
		...
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"DESTROY_PAGE_SOUNDS") ) { return DESTROY_PAGE_SOUNDS; }
		break;
	case 20:
...
Dynamic ApplicationFacade_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 14:
		...
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"INIT_PAGE_SOUNDS") ) { INIT_PAGE_SOUNDS=inValue.Cast< ::String >(); return inValue; }
		break;
	case 17:
	...
	case 18:
		...
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"DESTROY_PAGE_SOUNDS") ) { DESTROY_PAGE_SOUNDS=inValue.Cast< ::String >(); return inValue; }
		break;
	case 22:
...
static ::String sStaticFields[] = {
	...
	HX_CSTRING("INIT_PAGE_SOUNDS"),
	HX_CSTRING("DESTROY_PAGE_SOUNDS"),
	HX_CSTRING("instance"),
...
static void sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(ApplicationFacade_obj::INIT_PAGE_SOUNDS,"INIT_PAGE_SOUNDS");
	HX_MARK_MEMBER_NAME(ApplicationFacade_obj::DESTROY_PAGE_SOUNDS,"DESTROY_PAGE_SOUNDS");
...
static void sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(ApplicationFacade_obj::INIT_PAGE_SOUNDS,"INIT_PAGE_SOUNDS");
	HX_VISIT_MEMBER_NAME(ApplicationFacade_obj::DESTROY_PAGE_SOUNDS,"DESTROY_PAGE_SOUNDS");
...
void ApplicationFacade_obj::__boot()
{
	...
	INIT_PAGE_SOUNDS= HX_CSTRING("initPageSounds");
	DESTROY_PAGE_SOUNDS= HX_CSTRING("destroyPageSounds");
}
