...
{
HX_STACK_PUSH("TextEvent::new","native/events/TextEvent.hx",13);
...
::String TextEvent_obj::toString( ){
	HX_STACK_PUSH("TextEvent::toString","native/events/TextEvent.hx",29);
	HX_STACK_THIS(this);
	HX_STACK_LINE(29)
...
::native::events::Event TextEvent_obj::clone( ){
	HX_STACK_PUSH("TextEvent::clone","native/events/TextEvent.hx",22);
	HX_STACK_THIS(this);
	HX_STACK_LINE(22)
