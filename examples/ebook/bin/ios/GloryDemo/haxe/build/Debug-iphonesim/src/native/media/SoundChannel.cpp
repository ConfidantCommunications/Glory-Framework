...
{
HX_STACK_PUSH("SoundChannel::new","native/media/SoundChannel.hx",27);
{
	HX_STACK_LINE(29)
...
::native::media::SoundTransform SoundChannel_obj::set_soundTransform( ::native::media::SoundTransform inTransform){
	HX_STACK_PUSH("SoundChannel::set_soundTransform","native/media/SoundChannel.hx",163);
	HX_STACK_THIS(this);
...
::native::media::SoundTransform SoundChannel_obj::get_soundTransform( ){
	HX_STACK_PUSH("SoundChannel::get_soundTransform","native/media/SoundChannel.hx",150);
	HX_STACK_THIS(this);
	HX_STACK_LINE(152)
...
Float SoundChannel_obj::get_position( ){
	HX_STACK_PUSH("SoundChannel::get_position","native/media/SoundChannel.hx",147);
	HX_STACK_THIS(this);
	HX_STACK_LINE(147)
...
Float SoundChannel_obj::get_rightPeak( ){
	HX_STACK_PUSH("SoundChannel::get_rightPeak","native/media/SoundChannel.hx",146);
	HX_STACK_THIS(this);
	HX_STACK_LINE(146)
...
Float SoundChannel_obj::get_leftPeak( ){
	HX_STACK_PUSH("SoundChannel::get_leftPeak","native/media/SoundChannel.hx",145);
	HX_STACK_THIS(this);
	HX_STACK_LINE(145)
...
{
		HX_STACK_PUSH("SoundChannel::stop","native/media/SoundChannel.hx",130);
		HX_STACK_THIS(this);
		HX_STACK_LINE(132)
...
bool SoundChannel_obj::nmeCheckComplete( ){
	HX_STACK_PUSH("SoundChannel::nmeCheckComplete","native/media/SoundChannel.hx",60);
	HX_STACK_THIS(this);
	HX_STACK_LINE(62)
	if (((this->nmeHandle != null()))){
		HX_STACK_LINE(64)
...
::native::media::SoundChannel SoundChannel_obj::createDynamic( Dynamic inSoundHandle,::native::media::SoundTransform sndTransform,::native::events::EventDispatcher dataProvider){
	HX_STACK_PUSH("SoundChannel::createDynamic","native/media/SoundChannel.hx",46);
...
bool SoundChannel_obj::nmeCompletePending( ){
	HX_STACK_PUSH("SoundChannel::nmeCompletePending","native/media/SoundChannel.hx",100);
	HX_STACK_LINE(100)
...
{
		HX_STACK_PUSH("SoundChannel::nmePollComplete","native/media/SoundChannel.hx",107);
		HX_STACK_LINE(107)
