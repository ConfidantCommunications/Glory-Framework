...
{
HX_STACK_PUSH("Tilesheet::new","native/display/Tilesheet.hx",25);
{
	HX_STACK_LINE(27)
...
int flags = __o_flags.Default(0);
	HX_STACK_PUSH("Tilesheet::drawTiles","native/display/Tilesheet.hx",40);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Tilesheet::addTileRect","native/display/Tilesheet.hx",33);
		HX_STACK_THIS(this);
