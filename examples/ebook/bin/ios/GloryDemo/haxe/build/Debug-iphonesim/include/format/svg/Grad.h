...
class Grad_obj : public ::format::gfx::Gradient_obj{
	public:
		...
		Grad_obj();
		Void __construct(::native::display::GradientType inType);

	public:
		static hx::ObjectPtr< Grad_obj > __new(::native::display::GradientType inType);
		...
		virtual Void updateMatrix( ::native::geom::Matrix inMatrix);
		...
		Float x1; /* REM */ 
		Float radius; /* REM */ 
		::native::geom::Matrix gradMatrix; /* REM */ 
};
