...
::Xml PagesConfigProxy_obj::pagesXML( ){
	HX_STACK_PUSH("PagesConfigProxy::pagesXML","ca/confidant/glory/model/PagesConfigProxy.hx",206);
	HX_STACK_THIS(this);
	HX_STACK_LINE(206)
...
Dynamic PagesConfigProxy_obj::getConfigXML( int i){
	HX_STACK_PUSH("PagesConfigProxy::getConfigXML","ca/confidant/glory/model/PagesConfigProxy.hx",200);
	HX_STACK_THIS(this);
	HX_STACK_ARG(i,"i");
	HX_STACK_LINE(200)
...
{
		HX_STACK_PUSH("PagesConfigProxy::parseXML","ca/confidant/glory/model/PagesConfigProxy.hx",169);
		HX_STACK_THIS(this);
		HX_STACK_LINE(170)
...
int PagesConfigProxy_obj::numpages( ){
	HX_STACK_PUSH("PagesConfigProxy::numpages","ca/confidant/glory/model/PagesConfigProxy.hx",165);
	HX_STACK_THIS(this);
	HX_STACK_LINE(165)
...
Dynamic PagesConfigProxy_obj::getPosition( int i){
	HX_STACK_PUSH("PagesConfigProxy::getPosition","ca/confidant/glory/model/PagesConfigProxy.hx",162);
	HX_STACK_THIS(this);
	HX_STACK_ARG(i,"i");
	HX_STACK_LINE(162)
...
::Hash PagesConfigProxy_obj::getPage( ::String pageId){
	HX_STACK_PUSH("PagesConfigProxy::getPage","ca/confidant/glory/model/PagesConfigProxy.hx",154);
	HX_STACK_THIS(this);
...
::String PagesConfigProxy_obj::getActorHref( ::String controlId){
	HX_STACK_PUSH("PagesConfigProxy::getActorHref","ca/confidant/glory/model/PagesConfigProxy.hx",142);
	HX_STACK_THIS(this);
...
::String PagesConfigProxy_obj::getControlHref( ::String controlId){
	HX_STACK_PUSH("PagesConfigProxy::getControlHref","ca/confidant/glory/model/PagesConfigProxy.hx",130);
	HX_STACK_THIS(this);
	HX_STACK_ARG(controlId,"controlId");
	HX_STACK_LINE(131)
...
::List PagesConfigProxy_obj::getAppControls( ){
	HX_STACK_PUSH("PagesConfigProxy::getAppControls","ca/confidant/glory/model/PagesConfigProxy.hx",123);
	HX_STACK_THIS(this);
	HX_STACK_LINE(124)
	::haxe::Log_obj::trace(HX_CSTRING("getAppControls"),hx::SourceInfo(HX_CSTRING("PagesConfigProxy.hx"),124,HX_CSTRING("ca.confidant.glory.model.PagesConfigProxy"),HX_CSTRING("getAppControls")));
	HX_STACK_LINE(125)
	if ((this->fast->node->resolve(HX_CSTRING("controls"))->hasNode->resolve(HX_CSTRING("button")))){
		HX_STACK_LINE(125)
