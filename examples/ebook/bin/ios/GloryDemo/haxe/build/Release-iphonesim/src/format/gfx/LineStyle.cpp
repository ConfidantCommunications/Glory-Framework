...
HX_STACK_PUSH("LineStyle::new","format/gfx/LineStyle.hx",19);
{
	...
	HX_STACK_LINE(24)
	this->scaleMode = ::neash::display::LineScaleMode_obj::NORMAL_dyn();
	HX_STACK_LINE(25)
	this->capsStyle = ::neash::display::CapsStyle_obj::ROUND_dyn();
	HX_STACK_LINE(26)
	this->jointStyle = ::neash::display::JointStyle_obj::ROUND_dyn();
	HX_STACK_LINE(27)
	this->miterLimit = 3.0;
}
;
...
Dynamic LineStyle_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 5:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"capsStyle") ) { capsStyle=inValue.Cast< ::neash::display::CapsStyle >(); return inValue; }
	...
	case 10:
		...
		if (HX_FIELD_EQ(inName,"jointStyle") ) { jointStyle=inValue.Cast< ::neash::display::JointStyle >(); return inValue; }
		break;
	case 12:
