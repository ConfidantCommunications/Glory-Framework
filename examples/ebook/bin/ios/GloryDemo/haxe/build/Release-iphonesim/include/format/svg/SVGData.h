...
class SVGData_obj : public ::format::svg::Group_obj{
	...
	public:
		...
		virtual ::format::svg::Text loadText( ::Xml inText,::neash::geom::Matrix matrix,::Hash inStyles);
		Dynamic loadText_dyn();

		virtual ::format::svg::Path loadPath( ::Xml inPath,::neash::geom::Matrix matrix,::Hash inStyles,bool inIsRect,bool inIsEllipse);
		Dynamic loadPath_dyn();

		virtual ::format::svg::Group loadGroup( ::format::svg::Group g,::Xml inG,::neash::geom::Matrix matrix,::Hash inStyles);
		Dynamic loadGroup_dyn();

		virtual Void loadGradient( ::Xml inGrad,::neash::display::GradientType inType,bool inCrossLink);
		...
		virtual Float applyTransform( ::neash::geom::Matrix ioMatrix,::String inTrans);
