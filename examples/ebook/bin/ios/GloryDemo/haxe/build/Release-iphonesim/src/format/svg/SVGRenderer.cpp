...
::neash::display::BitmapData SVGRenderer_obj::renderBitmap( ::neash::geom::Rectangle inRect,hx::Null< Float >  __o_inScale){
...
{
		HX_STACK_LINE(310)
		this->mMatrix = ::neash::geom::Matrix_obj::__new(inScale,(int)0,(int)0,inScale,(-(inRect->x) * inScale),(-(inRect->y) * inScale));
		HX_STACK_LINE(312)
		...
		HX_STACK_LINE(318)
		this->mGfx = ::format::gfx::GfxGraphics_obj::__new(shape->nmeGetGraphics());
		HX_STACK_LINE(320)
...
::neash::display::Shape SVGRenderer_obj::namedShape( ::String inName){
...
::neash::display::Shape SVGRenderer_obj::createShape( ::neash::geom::Matrix inMatrix,Dynamic inFilter,::neash::geom::Rectangle inScale9){
	...
	::neash::display::Shape shape = ::neash::display::Shape_obj::__new();		HX_STACK_VAR(shape,"shape");
	HX_STACK_LINE(298)
	this->renderObject(shape,shape->nmeGetGraphics(),inMatrix,inFilter,inScale9);
	HX_STACK_LINE(299)
	return shape;
}
...
Void SVGRenderer_obj::renderSprite( ::neash::display::Sprite inObj,::neash::geom::Matrix inMatrix,Dynamic inFilter,::neash::geom::Rectangle inScale9){
{
		...
		HX_STACK_ARG(inScale9,"inScale9");
		HX_STACK_LINE(291)
		this->renderObject(inObj,inObj->nmeGetGraphics(),inMatrix,inFilter,inScale9);
	}
return null();
}
...
Void SVGRenderer_obj::renderObject( ::neash::display::DisplayObject inObj,::neash::display::Graphics inGfx,::neash::geom::Matrix inMatrix,Dynamic inFilter,::neash::geom::Rectangle inScale9){
{
		...
		HX_STACK_LINE(279)
		::neash::geom::Rectangle rect = this->getExtent(inMatrix, Dynamic(new _Function_1_1()),null());		HX_STACK_VAR(rect,"rect");
	}
return null();
}
...
::neash::geom::Rectangle SVGRenderer_obj::getMatchingRect( ::EReg inMatch){
...
::neash::geom::Rectangle SVGRenderer_obj::getExtent( ::neash::geom::Matrix inMatrix,Dynamic inFilter,Dynamic inIgnoreDot){
	...
	if (((inMatrix == null()))){
		HX_STACK_LINE(246)
		this->mMatrix = ::neash::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
	}
	else{
		HX_STACK_LINE(248)
...
Void SVGRenderer_obj::renderRect0( ::neash::display::Graphics inGfx,Dynamic inFilter,::neash::geom::Rectangle scaleRect,::neash::geom::Rectangle inBounds,::neash::geom::Rectangle inRect){
{
...
Void SVGRenderer_obj::renderRect( ::neash::display::Graphics inGfx,Dynamic inFilter,::neash::geom::Rectangle scaleRect,::neash::geom::Rectangle inBounds,::neash::geom::Rectangle inRect){
{
...
Void SVGRenderer_obj::render( ::neash::display::Graphics inGfx,::neash::geom::Matrix inMatrix,Dynamic inFilter,::neash::geom::Rectangle inScaleRect,Dynamic inScaleW,Dynamic inScaleH){
{
...
Void SVGRenderer_obj::iteratePath( ::format::svg::Path inPath){
{
		...
		HX_STACK_LINE(104)
		::neash::geom::Matrix m = inPath->matrix->clone();		HX_STACK_VAR(m,"m");
		HX_STACK_LINE(105)
