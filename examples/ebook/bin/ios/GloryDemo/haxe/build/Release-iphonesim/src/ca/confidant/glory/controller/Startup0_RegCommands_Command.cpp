...
{
HX_STACK_PUSH("Startup0_RegCommands_Command::new","ca/confidant/glory/controller/Startup0_RegCommands_Command.hx",22);
{
	HX_STACK_LINE(22)
	super::__construct();
}
...
{
		HX_STACK_PUSH("Startup0_RegCommands_Command::execute","ca/confidant/glory/controller/Startup0_RegCommands_Command.hx",26);
		HX_STACK_THIS(this);
		HX_STACK_ARG(note,"note");
		HX_STACK_LINE(27)
		::haxe::Log_obj::trace(HX_CSTRING("startup0"),hx::SourceInfo(HX_CSTRING("Startup0_RegCommands_Command.hx"),27,HX_CSTRING("ca.confidant.glory.controller.Startup0_RegCommands_Command"),HX_CSTRING("execute")));
		HX_STACK_LINE(28)
