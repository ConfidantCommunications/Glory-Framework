...
class ApplicationMediator_obj : public ::org::puremvc::haxe::patterns::mediator::Mediator_obj{
	...
	public:
		...
		virtual int getIndex( ::neash::display::DisplayObject d);
		Dynamic getIndex_dyn();

		virtual Void reportLayers( );
		Dynamic reportLayers_dyn();

		virtual Void removeDisplayObject( ::neash::display::DisplayObject d);
		Dynamic removeDisplayObject_dyn();

		virtual Void addDisplayObject( ::neash::display::DisplayObject d,hx::Null< int >  level);
