...
{
HX_STACK_PUSH("StartupCommand::new","ca/confidant/glory/controller/StartupCommand.hx",15);
{
	HX_STACK_LINE(15)
	super::__construct();
}
...
{
		HX_STACK_PUSH("StartupCommand::initializeMacroCommand","ca/confidant/glory/controller/StartupCommand.hx",20);
		HX_STACK_THIS(this);
		HX_STACK_LINE(22)
