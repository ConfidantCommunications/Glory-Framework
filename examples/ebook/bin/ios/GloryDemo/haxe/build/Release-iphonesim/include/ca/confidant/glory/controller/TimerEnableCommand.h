...
HX_DECLARE_CLASS4(ca,confidant,glory,controller,TimerEnableCommand)
...
class TimerEnableCommand_obj : public ::org::puremvc::haxe::patterns::command::SimpleCommand_obj{
	public:
		typedef ::org::puremvc::haxe::patterns::command::SimpleCommand_obj super;
		typedef TimerEnableCommand_obj OBJ_;
		TimerEnableCommand_obj();
		Void __construct();

	public:
		static hx::ObjectPtr< TimerEnableCommand_obj > __new();
		...
		::String __ToString() const { return HX_CSTRING("TimerEnableCommand"); }
...
#endif /* INCLUDED_ca_confidant_glory_controller_TimerEnableCommand */ 
