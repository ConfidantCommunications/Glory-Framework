...
Void ApplicationMain_obj::main( ){
{
		...
		Void run(){
			HX_STACK_PUSH("*::_Function_1_2","ApplicationMain.hx",21);
			{
				...
				HX_STACK_LINE(30)
				::nme::Lib_obj::nmeGetCurrent()->nmeGetStage()->addEventListener(::neash::events::Event_obj::RESIZE,::ApplicationMain_obj::initialize_dyn(),null(),null(),null());
			}
			return null();
		}
...
Void ApplicationMain_obj::initialize( ::neash::events::Event event){
{
		HX_STACK_PUSH("ApplicationMain::initialize","ApplicationMain.hx",47);
		HX_STACK_ARG(event,"event");
		HX_STACK_LINE(48)
		::nme::Lib_obj::nmeGetCurrent()->nmeGetStage()->removeEventListener(::neash::events::Event_obj::RESIZE,::ApplicationMain_obj::initialize_dyn(),null());
		HX_STACK_LINE(50)
