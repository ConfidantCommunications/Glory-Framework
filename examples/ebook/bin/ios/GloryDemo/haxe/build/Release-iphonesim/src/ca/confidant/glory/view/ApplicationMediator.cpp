...
::ca::confidant::glory::GloryFrameworkApp ApplicationMediator_obj::getApp( ){
	HX_STACK_PUSH("ApplicationMediator::getApp","ca/confidant/glory/view/ApplicationMediator.hx",86);
	HX_STACK_THIS(this);
	HX_STACK_LINE(86)
...
{
		HX_STACK_PUSH("ApplicationMediator::handleNotification","ca/confidant/glory/view/ApplicationMediator.hx",72);
		HX_STACK_THIS(this);
...
int ApplicationMediator_obj::getIndex( ::neash::display::DisplayObject d){
	HX_STACK_PUSH("ApplicationMediator::getIndex","ca/confidant/glory/view/ApplicationMediator.hx",68);
	HX_STACK_THIS(this);
	HX_STACK_ARG(d,"d");
	HX_STACK_LINE(68)
...
{
		HX_STACK_PUSH("ApplicationMediator::reportLayers","ca/confidant/glory/view/ApplicationMediator.hx",63);
		HX_STACK_THIS(this);
		HX_STACK_LINE(64)
		...
		while(((_g1 < _g))){
			...
			HX_STACK_LINE(65)
			::haxe::Log_obj::trace((((HX_CSTRING("layer:") + this->getApp()->getChildAt(i)->nmeGetName()) + HX_CSTRING(":")) + i),hx::SourceInfo(HX_CSTRING("ApplicationMediator.hx"),65,HX_CSTRING("ca.confidant.glory.view.ApplicationMediator"),HX_CSTRING("reportLayers")));
		}
	}
return null();
}
...
{
		HX_STACK_PUSH("ApplicationMediator::removeDisplayObject","ca/confidant/glory/view/ApplicationMediator.hx",60);
		HX_STACK_THIS(this);
		HX_STACK_ARG(d,"d");
		HX_STACK_LINE(60)
