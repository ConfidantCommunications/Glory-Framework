...
class ControlsRegistryProxy_obj : public ::org::puremvc::haxe::patterns::proxy::Proxy_obj{
	...
	public:
		...
		virtual Void registerControl( ::neash::display::DisplayObject d);
		Dynamic registerControl_dyn();

		virtual Array< ::neash::display::DisplayObject > getControls( );
		Dynamic getControls_dyn();

		Array< ::neash::display::DisplayObject > controls; /* REM */ 
		int currentPage; /* REM */ 
