...
Void GfxGraphics_obj::__construct(::neash::display::Graphics inGraphics)
{
...
hx::ObjectPtr< GfxGraphics_obj > GfxGraphics_obj::__new(::neash::display::Graphics inGraphics)
