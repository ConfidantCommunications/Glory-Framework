...
Void Grad_obj::__construct(::neash::display::GradientType inType)
{
HX_STACK_PUSH("Grad::new","format/svg/Grad.hx",23);
{
	...
	this->radius = 0.0;
	HX_STACK_LINE(27)
	this->gradMatrix = ::neash::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
	HX_STACK_LINE(28)
	this->x1 = 0.0;
	HX_STACK_LINE(29)
	this->y1 = 0.0;
...
hx::ObjectPtr< Grad_obj > Grad_obj::__new(::neash::display::GradientType inType)
...
Void Grad_obj::updateMatrix( ::neash::geom::Matrix inMatrix){
{
		...
		HX_STACK_LINE(43)
		if (((this->type == ::neash::display::GradientType_obj::LINEAR_dyn()))){
			HX_STACK_LINE(45)
...
Dynamic Grad_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 6:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"gradMatrix") ) { gradMatrix=inValue.Cast< ::neash::geom::Matrix >(); return inValue; }
	}
