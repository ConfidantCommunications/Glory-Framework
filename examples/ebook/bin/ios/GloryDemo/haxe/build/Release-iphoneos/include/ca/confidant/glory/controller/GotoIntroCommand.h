...
#define INCLUDED_ca_confidant_glory_controller_GotoIntroCommand
...
HX_DECLARE_CLASS4(ca,confidant,glory,controller,GotoIntroCommand)
...
class GotoIntroCommand_obj : public ::org::puremvc::haxe::patterns::command::SimpleCommand_obj{
	public:
		typedef ::org::puremvc::haxe::patterns::command::SimpleCommand_obj super;
		typedef GotoIntroCommand_obj OBJ_;
		GotoIntroCommand_obj();
		Void __construct();

	public:
		static hx::ObjectPtr< GotoIntroCommand_obj > __new();
		...
		::String __ToString() const { return HX_CSTRING("GotoIntroCommand"); }
...
#endif /* INCLUDED_ca_confidant_glory_controller_GotoIntroCommand */ 
