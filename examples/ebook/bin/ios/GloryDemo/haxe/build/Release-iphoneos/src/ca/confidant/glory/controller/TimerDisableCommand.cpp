...
{
HX_STACK_PUSH("TimerDisableCommand::new","ca/confidant/glory/controller/TimerDisableCommand.hx",16);
{
	HX_STACK_LINE(16)
	super::__construct();
}
...
Void TimerDisableCommand_obj::execute( ::org::puremvc::haxe::interfaces::INotification note){
{
		...
		HX_STACK_LINE(21)
		::haxe::Log_obj::trace(HX_CSTRING("TimerDisableCommand"),hx::SourceInfo(HX_CSTRING("TimerDisableCommand.hx"),21,HX_CSTRING("ca.confidant.glory.controller.TimerDisableCommand"),HX_CSTRING("execute")));
		HX_STACK_LINE(22)
