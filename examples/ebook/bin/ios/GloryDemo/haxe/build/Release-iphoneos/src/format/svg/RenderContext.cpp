...
Void RenderContext_obj::__construct(::neash::geom::Matrix inMatrix,::neash::geom::Rectangle inRect,Dynamic inW,Dynamic inH)
{
...
hx::ObjectPtr< RenderContext_obj > RenderContext_obj::__new(::neash::geom::Matrix inMatrix,::neash::geom::Rectangle inRect,Dynamic inW,Dynamic inH)
