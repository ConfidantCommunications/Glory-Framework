...
{
HX_STACK_PUSH("ControlsRegistryProxy::new","ca/confidant/glory/model/ControlsRegistryProxy.hx",21);
{
	HX_STACK_LINE(22)
	...
	HX_STACK_LINE(25)
	::haxe::Log_obj::trace(HX_CSTRING("ControlsRegistryProxy!"),hx::SourceInfo(HX_CSTRING("ControlsRegistryProxy.hx"),25,HX_CSTRING("ca.confidant.glory.model.ControlsRegistryProxy"),HX_CSTRING("new")));
}
;
	return null();
}
...
{
		HX_STACK_PUSH("ControlsRegistryProxy::registerControl","ca/confidant/glory/model/ControlsRegistryProxy.hx",31);
		HX_STACK_THIS(this);
		HX_STACK_ARG(d,"d");
		HX_STACK_LINE(31)
...
Array< ::neash::display::DisplayObject > ControlsRegistryProxy_obj::getControls( ){
	HX_STACK_PUSH("ControlsRegistryProxy::getControls","ca/confidant/glory/model/ControlsRegistryProxy.hx",27);
	HX_STACK_THIS(this);
	HX_STACK_LINE(28)
	::haxe::Log_obj::trace(HX_CSTRING("crp:getControls"),hx::SourceInfo(HX_CSTRING("ControlsRegistryProxy.hx"),28,HX_CSTRING("ca.confidant.glory.model.ControlsRegistryProxy"),HX_CSTRING("getControls")));
	HX_STACK_LINE(29)
