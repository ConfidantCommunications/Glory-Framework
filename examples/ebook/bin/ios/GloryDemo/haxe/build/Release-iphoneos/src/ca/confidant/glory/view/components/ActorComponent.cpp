...
{
HX_STACK_PUSH("ActorComponent::new","ca/confidant/glory/view/components/ActorComponent.hx",19);
{
	HX_STACK_LINE(20)
	super::__construct();
	HX_STACK_LINE(22)
...
{
		HX_STACK_PUSH("ActorComponent::addSVG","ca/confidant/glory/view/components/ActorComponent.hx",29);
		HX_STACK_THIS(this);
		HX_STACK_ARG(t,"t");
		HX_STACK_LINE(30)
...
{
		HX_STACK_PUSH("ActorComponent::addBitmap","ca/confidant/glory/view/components/ActorComponent.hx",25);
		HX_STACK_THIS(this);
