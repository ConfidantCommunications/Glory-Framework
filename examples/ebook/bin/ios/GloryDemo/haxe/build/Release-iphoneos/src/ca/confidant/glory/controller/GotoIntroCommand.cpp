...
{
HX_STACK_PUSH("GotoIntroCommand::new","ca/confidant/glory/controller/GotoIntroCommand.hx",16);
{
	HX_STACK_LINE(16)
	super::__construct();
}
...
{
		HX_STACK_PUSH("GotoIntroCommand::execute","ca/confidant/glory/controller/GotoIntroCommand.hx",23);
		HX_STACK_THIS(this);
		HX_STACK_ARG(note,"note");
		HX_STACK_LINE(24)
		::haxe::Log_obj::trace(HX_CSTRING("GotoIntroCommand"),hx::SourceInfo(HX_CSTRING("GotoIntroCommand.hx"),24,HX_CSTRING("ca.confidant.glory.controller.GotoIntroCommand"),HX_CSTRING("execute")));
		HX_STACK_LINE(25)
