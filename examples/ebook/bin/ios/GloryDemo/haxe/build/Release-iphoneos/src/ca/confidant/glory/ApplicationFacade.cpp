...
{
HX_STACK_PUSH("ApplicationFacade::new","ca/confidant/glory/ApplicationFacade.hx",14);
{
	HX_STACK_LINE(14)
	super::__construct();
}
...
::String ApplicationFacade_obj::INIT_WIDGETS_CONFIG;

::String ApplicationFacade_obj::ASSETS_LOADED;

::String ApplicationFacade_obj::INIT_WIDGETS;
...
Dynamic ApplicationFacade_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 11:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"INIT_WIDGETS") ) { return INIT_WIDGETS; }
	...
	case 18:
		...
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"INIT_WIDGETS_CONFIG") ) { return INIT_WIDGETS_CONFIG; }
		break;
	case 20:
...
Dynamic ApplicationFacade_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 11:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"INIT_WIDGETS") ) { INIT_WIDGETS=inValue.Cast< ::String >(); return inValue; }
	...
	case 18:
		...
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"INIT_WIDGETS_CONFIG") ) { INIT_WIDGETS_CONFIG=inValue.Cast< ::String >(); return inValue; }
		break;
	case 22:
...
static ::String sStaticFields[] = {
	...
	HX_CSTRING("INIT_WIDGETS_CONFIG"),
	HX_CSTRING("ASSETS_LOADED"),
	HX_CSTRING("INIT_WIDGETS"),
...
static void sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(ApplicationFacade_obj::INIT_WIDGETS_CONFIG,"INIT_WIDGETS_CONFIG");
	HX_MARK_MEMBER_NAME(ApplicationFacade_obj::ASSETS_LOADED,"ASSETS_LOADED");
	HX_MARK_MEMBER_NAME(ApplicationFacade_obj::INIT_WIDGETS,"INIT_WIDGETS");
...
static void sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(ApplicationFacade_obj::INIT_WIDGETS_CONFIG,"INIT_WIDGETS_CONFIG");
	HX_VISIT_MEMBER_NAME(ApplicationFacade_obj::ASSETS_LOADED,"ASSETS_LOADED");
	HX_VISIT_MEMBER_NAME(ApplicationFacade_obj::INIT_WIDGETS,"INIT_WIDGETS");
...
void ApplicationFacade_obj::__boot()
{
	...
	INIT_WIDGETS_CONFIG= HX_CSTRING("initWidgetsConfig");
	ASSETS_LOADED= HX_CSTRING("assetsLoaded");
	INIT_WIDGETS= HX_CSTRING("initWidgets");
