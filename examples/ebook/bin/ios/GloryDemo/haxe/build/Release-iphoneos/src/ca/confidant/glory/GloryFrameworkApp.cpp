...
{
HX_STACK_PUSH("GloryFrameworkApp::new","ca/confidant/glory/GloryFrameworkApp.hx",13);
{
	HX_STACK_LINE(14)
	super::__construct();
	HX_STACK_LINE(15)
...
{
		HX_STACK_PUSH("GloryFrameworkApp::displayMessage","ca/confidant/glory/GloryFrameworkApp.hx",25);
		HX_STACK_THIS(this);
		HX_STACK_ARG(m,"m");
	}
return null();
...
{
		HX_STACK_PUSH("GloryFrameworkApp::main","ca/confidant/glory/GloryFrameworkApp.hx",21);
		HX_STACK_LINE(22)
		::ca::confidant::glory::GloryFrameworkApp app = ::ca::confidant::glory::GloryFrameworkApp_obj::__new();		HX_STACK_VAR(app,"app");
		HX_STACK_LINE(23)
		::nme::Lib_obj::nmeGetCurrent()->addChild(app);
	}
return null();
}
