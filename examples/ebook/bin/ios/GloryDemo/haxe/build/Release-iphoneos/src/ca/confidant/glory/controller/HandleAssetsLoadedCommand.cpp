...
{
HX_STACK_PUSH("HandleAssetsLoadedCommand::new","ca/confidant/glory/controller/HandleAssetsLoadedCommand.hx",23);
{
	HX_STACK_LINE(23)
	super::__construct();
}
...
{
		HX_STACK_PUSH("HandleAssetsLoadedCommand::execute","ca/confidant/glory/controller/HandleAssetsLoadedCommand.hx",28);
		HX_STACK_THIS(this);
		HX_STACK_ARG(note,"note");
		HX_STACK_LINE(29)
		::haxe::Log_obj::trace(HX_CSTRING("HandleAssetsLoadedCommand"),hx::SourceInfo(HX_CSTRING("HandleAssetsLoadedCommand.hx"),29,HX_CSTRING("ca.confidant.glory.controller.HandleAssetsLoadedCommand"),HX_CSTRING("execute")));
		HX_STACK_LINE(30)
