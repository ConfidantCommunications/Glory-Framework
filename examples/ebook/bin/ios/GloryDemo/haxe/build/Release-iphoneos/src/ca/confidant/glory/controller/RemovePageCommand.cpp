...
{
HX_STACK_PUSH("RemovePageCommand::new","ca/confidant/glory/controller/RemovePageCommand.hx",24);
{
	HX_STACK_LINE(24)
	super::__construct();
}
...
{
		HX_STACK_PUSH("RemovePageCommand::execute","ca/confidant/glory/controller/RemovePageCommand.hx",30);
		HX_STACK_THIS(this);
