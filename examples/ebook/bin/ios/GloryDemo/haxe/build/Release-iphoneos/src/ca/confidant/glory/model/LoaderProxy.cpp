...
{
		HX_STACK_PUSH("LoaderProxy::loadAllAssets","ca/confidant/glory/model/LoaderProxy.hx",68);
		HX_STACK_THIS(this);
		HX_STACK_LINE(68)
...
::neash::display::BitmapData LoaderProxy_obj::getBitmapData( ::String id,hx::Null< bool >  __o_b){
...
{
		HX_STACK_LINE(61)
		::neash::display::BitmapData imageData = ::nme::installer::Assets_obj::getBitmapData(id,b);		HX_STACK_VAR(imageData,"imageData");
		HX_STACK_LINE(62)
		return imageData;
	}
}
