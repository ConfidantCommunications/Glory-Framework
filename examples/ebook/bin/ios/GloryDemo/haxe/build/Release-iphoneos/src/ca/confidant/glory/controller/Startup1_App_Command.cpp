...
{
HX_STACK_PUSH("Startup1_App_Command::new","ca/confidant/glory/controller/Startup1_App_Command.hx",13);
{
	HX_STACK_LINE(13)
	super::__construct();
}
...
{
		HX_STACK_PUSH("Startup1_App_Command::execute","ca/confidant/glory/controller/Startup1_App_Command.hx",17);
		HX_STACK_THIS(this);
		HX_STACK_ARG(note,"note");
		HX_STACK_LINE(18)
		::haxe::Log_obj::trace(HX_CSTRING("startup1"),hx::SourceInfo(HX_CSTRING("Startup1_App_Command.hx"),18,HX_CSTRING("ca.confidant.glory.controller.Startup1_App_Command"),HX_CSTRING("execute")));
		HX_STACK_LINE(19)
