...
class SVGRenderer_obj : public hx::Object{
	...
	public:
		...
		virtual ::neash::display::BitmapData renderBitmap( ::neash::geom::Rectangle inRect,hx::Null< Float >  inScale);
		Dynamic renderBitmap_dyn();

		virtual ::neash::display::Shape namedShape( ::String inName);
		Dynamic namedShape_dyn();

		virtual ::neash::display::Shape createShape( ::neash::geom::Matrix inMatrix,Dynamic inFilter,::neash::geom::Rectangle inScale9);
		Dynamic createShape_dyn();

		virtual Void renderSprite( ::neash::display::Sprite inObj,::neash::geom::Matrix inMatrix,Dynamic inFilter,::neash::geom::Rectangle inScale9);
		Dynamic renderSprite_dyn();

		virtual Void renderObject( ::neash::display::DisplayObject inObj,::neash::display::Graphics inGfx,::neash::geom::Matrix inMatrix,Dynamic inFilter,::neash::geom::Rectangle inScale9);
		Dynamic renderObject_dyn();

		virtual ::neash::geom::Rectangle getMatchingRect( ::EReg inMatch);
		Dynamic getMatchingRect_dyn();

		virtual ::format::svg::Text findText( Dynamic inFilter);
		Dynamic findText_dyn();

		virtual ::neash::geom::Rectangle getExtent( ::neash::geom::Matrix inMatrix,Dynamic inFilter,Dynamic inIgnoreDot);
		Dynamic getExtent_dyn();

		virtual Void renderRect0( ::neash::display::Graphics inGfx,Dynamic inFilter,::neash::geom::Rectangle scaleRect,::neash::geom::Rectangle inBounds,::neash::geom::Rectangle inRect);
		Dynamic renderRect0_dyn();

		virtual Void renderRect( ::neash::display::Graphics inGfx,Dynamic inFilter,::neash::geom::Rectangle scaleRect,::neash::geom::Rectangle inBounds,::neash::geom::Rectangle inRect);
		Dynamic renderRect_dyn();

		virtual Void render( ::neash::display::Graphics inGfx,::neash::geom::Matrix inMatrix,Dynamic inFilter,::neash::geom::Rectangle inScaleRect,Dynamic inScaleW,Dynamic inScaleH);
		Dynamic render_dyn();
		...
		Dynamic mScaleH; /* REM */ 
		Dynamic mScaleW; /* REM */ 
		::neash::geom::Rectangle mScaleRect; /* REM */ 
		::neash::geom::Matrix mMatrix; /* REM */ 
