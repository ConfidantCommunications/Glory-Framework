...
{
HX_STACK_PUSH("BuildControlsCommand::new","ca/confidant/glory/controller/BuildControlsCommand.hx",25);
{
	HX_STACK_LINE(25)
	super::__construct();
}
...
{
		HX_STACK_PUSH("BuildControlsCommand::makeControl","ca/confidant/glory/controller/BuildControlsCommand.hx",47);
		HX_STACK_THIS(this);
		...
		try{
		...
		catch(Dynamic __e){
			{
				Dynamic e = __e;{
					HX_STACK_LINE(74)
					::haxe::Log_obj::trace(::Std_obj::string(e),hx::SourceInfo(HX_CSTRING("BuildControlsCommand.hx"),75,HX_CSTRING("ca.confidant.glory.controller.BuildControlsCommand"),HX_CSTRING("makeControl")));
				}
			}
		}
	}
...
{
		HX_STACK_PUSH("BuildControlsCommand::execute","ca/confidant/glory/controller/BuildControlsCommand.hx",32);
		HX_STACK_THIS(this);
		HX_STACK_ARG(note,"note");
		HX_STACK_LINE(33)
		::haxe::Log_obj::trace(HX_CSTRING("BuildControlsCommand"),hx::SourceInfo(HX_CSTRING("BuildControlsCommand.hx"),33,HX_CSTRING("ca.confidant.glory.controller.BuildControlsCommand"),HX_CSTRING("execute")));
		HX_STACK_LINE(34)
