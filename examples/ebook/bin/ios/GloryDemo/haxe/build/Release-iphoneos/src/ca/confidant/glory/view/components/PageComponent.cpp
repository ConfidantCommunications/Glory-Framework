...
{
HX_STACK_PUSH("PageComponent::new","ca/confidant/glory/view/components/PageComponent.hx",13);
{
	HX_STACK_LINE(14)
	super::__construct();
	HX_STACK_LINE(15)
	...
	HX_STACK_LINE(17)
	::haxe::Log_obj::trace(HX_CSTRING("new Page!"),hx::SourceInfo(HX_CSTRING("PageComponent.hx"),17,HX_CSTRING("ca.confidant.glory.view.components.PageComponent"),HX_CSTRING("new")));
}
;
	return null();
}
...
{
		HX_STACK_PUSH("PageComponent::init","ca/confidant/glory/view/components/PageComponent.hx",28);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
		HX_STACK_PUSH("PageComponent::addActor","ca/confidant/glory/view/components/PageComponent.hx",20);
		HX_STACK_THIS(this);
