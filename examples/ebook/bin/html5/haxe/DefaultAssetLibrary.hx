...
@:keep @:bind #if display private #end class __ASSET__assets_nme_svg extends null { }
...
@:keep @:bind #if display private #end class __ASSET__assets_p1_limerickpcm_wav extends null { }
...
@:keep @:bind #if display private #end class __ASSET__assets_title_star_svg extends null { }
